nav = `    <nav class="navbar navbar-vertical navbar-expand-lg navbar-light">
      <a class="navbar-brand mx-auto d-none d-lg-block my-0 my-lg-4" href="#">
        ...
        />
        <img
          src="../assets/svg/brand/muze-icon.svg"
          class="muze-icon"
          alt="Muze"
        />
        <img
          src="../assets/svg/brand/muze-icon-white.svg"
          class="muze-icon-white"
          alt="Muze"
        />
      </a>
      <div class="navbar-collapse">
        <ul class="navbar-nav mb-2" id="accordionExample" data-simplebar>
          ...
          <li class="nav-item">
            ...
            <div
              class="collapse collapse-box show"
              id="sidebarPages"
              data-bs-parent="#accordionExample"
            >
              <ul class="nav nav-sm flex-column" id="submenu">
                ...
                <li class="nav-item">
                  ...
                  >
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item">
                        <a href="user-profile-general.html" class="nav-link"
                          >General</a
                        >
                      </li>
                      <li class="nav-item">
                        <a href="user-profile-activity.html" class="nav-link"
                          >Activity</a
                        >
                      </li>
                      <li class="nav-item">
                        <a href="user-profile-friends.html" class="nav-link"
                          >Friends</a
                        >
                      </li>
                      <li class="nav-item">
                        <a href="user-profile-groups.html" class="nav-link"
                          >Groups</a
                        >
                      </li>
                    </ul>
              ...
              <ul class="nav nav-sm flex-column" id="submenu2">
                ...
                <li class="nav-item">
                  ...
                  >
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item">
                        <a href="reset-password-simple.html" class="nav-link"
                          >Simple</a
                        >
                      </li>
                      <li class="nav-item">
                ...
                <li class="nav-item">
                  <a
                    ...
                    role="button"
                    aria-expanded="false"
                    aria-controls="Emailverification"
                  ...
                  >
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item">
                        <a href="verify-email-simple.html" class="nav-link"
                          >Simple</a
                        >
                      </li>
                      <li class="nav-item">
                        <a href="verify-email-cover.html" class="nav-link"
                          >Cover</a
                        >
                      </li>
                    </ul>
          ...
          <li class="nav-item">
            ...
            >
              ...
              &nbsp;<span class="ms-2 position-relative"
                >Apps
                <sup class="status bg-warning ms-2 position-absolute"
                  >&nbsp;</sup
                ></span
              >
            </a>
        ...
        <div class="mt-3 mt-md-auto mb-3 signout d-grid">
          <a
            ...
            class="btn btn-dark btn-lg customize-btn"
            ><img
              src="../assets/svg/icons/dark-mode@24.svg"
              alt="Customize"
          ...
          <ul class="navbar-vertical-footer-list">
            ...
            <li class="dropup">
              <a
                ...
                aria-expanded="false"
                ><img
                  src="../assets/svg/icons/united-states.svg"
                  alt="United States"
              ...
              >
                ...
                <li>
                  <a class="dropdown-item" href="#">
                    <img
                      class="avatar avatar-xss avatar-circle me-2"
                      src="../assets/svg/icons/dutch.svg"
                      alt="Flag"
                    />
                ...
                <li>
                  <a class="dropdown-item" href="#">
                    <img
                      class="avatar avatar-xss avatar-circle me-2"
                      src="../assets/svg/icons/latin.svg"
                      alt="Flag"
                    />
