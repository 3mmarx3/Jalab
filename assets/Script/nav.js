nav = `   <nav class="navbar navbar-vertical navbar-expand-lg navbar-light">
      ...
      <div class="navbar-collapse">
          ...
          <li class="nav-item">
            ...
            <div class="collapse collapse-box show" id="sidebarPages" data-bs-parent="#accordionExample">
              <ul class="nav nav-sm flex-column" id="submenu">
                <li class="nav-item">
                  <a class="nav-link collapsed" href="../Page/Create_User.html">Create User</a>
              
                </li>
                <li class="nav-item">
                  <a class="nav-link collapsed" href="../Page/Client.html">Client</a>
        ...
        <div class="mt-3 mt-md-auto mb-3 signout d-grid">
          <a href="javascript:void(0);" class="btn btn-dark btn-lg customize-btn"><span class="ps-2">Customize</span></a>
        </div>
...
let nav_bar = document.getElementById("nav_");
