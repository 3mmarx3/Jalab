...
var customizerBody = document
  .querySelector("body")
  .classList.add(
    localStorage.getItem("skins"),
    localStorage.getItem("headerStyles"),
    localStorage.getItem("sidebarStyles")
  );
...
if (localStorage.getItem("rtlModeCheck") == "true") {
  ...
  var customizerHtml = document
    .querySelector("html")
    .setAttribute("dir", "rtl");
  var customizerBody = document
    .querySelector("body")
    .classList.add(localStorage.getItem("rtlModeValue"));
...
if (localStorage.getItem("fluidLayoutCheck") == "true") {
  ...
  var customizerBody = document
    .querySelector("body")
    .classList.remove(localStorage.getItem("fluidLayoutValue"));
} else {
  var customizerBody = document
    .querySelector("body")
    .classList.add(localStorage.getItem("fluidLayoutValue"));
}
...
document
  .querySelector("#CustomizerPreview")
