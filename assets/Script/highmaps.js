...
(function (V, O) {
  "object" === typeof module && module.exports
    ? ((O["default"] = O), (module.exports = V.document ? O(V) : O))
  ...
  O(q, "Core/Utilities.js", [q["Core/Globals.js"]], function (n) {
    function h(d, t, a, b) {
      ...
      var f = u(d),
        J = f
          ? c + " #" + d + ": www.highcharts.com/errors/" + d + "/"
          : d.toString();
      c = function () {
        if (t) throw Error(J);
        r.console && -1 === h.messages.indexOf(J) && console.log(J);
      };
      ...
      a ? aa(a, "displayError", { code: d, message: J, params: b }, c) : c();
      h.messages.push(J);
    }
    function q() {
      var d,
    ...
    function M(d, t) {
      ...
      for (
        d = a.pop();
        "undefined" !== typeof d && "undefined" !== typeof t && null !== t;
    ...
    var H = (n.isDOMElement = function (d) {
      ...
      v = (n.isClass = function (d) {
        ...
        return !(!z(d, !0) || H(d) || !t || !t.name || "Object" === t.name);
      }),
    ...
    var b = (n.css = function (d, t) {
        n.isMS &&
          ...
          (t.filter = "alpha(opacity=" + 100 * t.opacity + ")");
        f(d.style, t);
      }),
      l = (n.createElement = function (d, t, a, c, J) {
        d = B.createElement(d);
        t && f(d, t);
        J && b(d, { padding: "0", border: "none", margin: "0" });
        a && b(d, a);
        c && c.appendChild(d);
        return d;
      }),
      ...
      x = (n.pad = function (d, t, a) {
        return (
          Array((t || 2) + 1 - String(d).replace("-", "").length).join(
            a || "0"
          ) + d
        );
      }),
      ...
      R = (n.normalizeTickInterval = function (d, t, a, b, c) {
        ...
        for (
          ...
          b < t.length &&
          !((f = t[b]),
          (c && f * a >= d) || (!c && l <= (t[b] + (t[b + 1] || t[b])) / 2));
          b++
        );
        return (f = J(f * a, -Math.round(Math.log(0.001) / Math.LN10)));
      }),
      ...
      Q = (n.numberFormat = function (d, t, a, b) {
        d = +d || 0;
        t = +t;
        ...
        if (-1 === t) t = Math.min(J, 20);
          ...
          var l = t + +f[1];
          0 <= l
            ? ((f[0] = (+f[0]).toExponential(l).split("e")[0]), (t = l))
            : ((f[0] = f[0].split(".")[0] || 0),
              (d = 20 > t ? (f[0] * Math.pow(10, f[1])).toFixed(t) : 0),
              (f[1] = 0));
        }
        var e = (
          Math.abs(f[1] ? f[0] : d) + Math.pow(10, -Math.max(t, J) - 1)
        ).toFixed(t);
        J = String(m(e));
    ...
    var ba = (n.getStyle = function (d, t, a) {
        if ("width" === t)
          return (
            (t = Math.min(d.offsetWidth, d.scrollWidth)),
            (a = d.getBoundingClientRect && d.getBoundingClientRect().width),
            a < t && a >= t - 1 && (t = Math.floor(a)),
            Math.max(
              0,
              t - n.getStyle(d, "padding-left") - n.getStyle(d, "padding-right")
            )
          );
        if ("height" === t)
          return Math.max(
            ...
            Math.min(d.offsetHeight, d.scrollHeight) -
              n.getStyle(d, "padding-top") -
              n.getStyle(d, "padding-bottom")
          );
        r.getComputedStyle || h(27, !0);
        if ((d = r.getComputedStyle(d, void 0)))
          (d = d.getPropertyValue(t)), F(a, "opacity" !== t) && (d = m(d));
        return d;
      }),
      ...
      Z = (n.find = Array.prototype.find
        ...
        : function (d, t) {
            var a,
              b = d.length;
            for (a = 0; a < b; a++) if (t(d[a], a)) return d[a];
          });
    n.keys = function (d) {
    ...
    var X = (n.offset = function (d) {
      ...
      S = (n.objectEach = function (d, t, a) {
        for (var b in d)
          Object.hasOwnProperty.call(d, b) && t.call(a || d[b], d[b], b, d);
      });
    S(
      {
        map: "map",
      ...
      function (d, t) {
        n[t] = function (a) {
          ...
          h(
            ...
            !1,
            void 0,
            ((b = {}), (b["Highcharts." + t] = "use Array." + d), b)
          );
    ...
    var W = (n.addEvent = function (d, t, a, b) {
      ...
      U = (n.removeEvent = function (d, t, a) {
        ...
        function c(a) {
          ...
          if (d.nodeName) {
            ...
            S(f, function (d, t) {
              if (a[t]) for (c = a[t].length; c--; ) b(t, a[t][c].fn);
            });
          }
        }
        var f;
      ...
      ia = (n.setOptions = function (d) {
        n.defaultOptions = q(!0, n.defaultOptions, d);
        (d.time || d.global) &&
          n.time.update(
            q(n.defaultOptions.global, n.defaultOptions.time, d.global, d.time)
          );
        return n.defaultOptions;
      });
    r.jQuery &&
      (r.jQuery.fn.highcharts = function () {
        ...
        if (this[0])
          return d[0]
            ? (new n[g(d[0]) ? d.shift() : "Chart"](this[0], d[0], d[1]), this)
            : G[y(this[0], "data-highcharts-chart")];
      });
    return {
      addEvent: W,
      arrayMax: w,
    ...
    function (n, h) {
      ...
      h = (function () {
        ...
        h.prototype.init = function (n) {
          ...
          if (
            (this.input = n =
              h.names[n && n.toLowerCase ? n.toLowerCase() : ""] || n) &&
            n.stops
          )
            this.stops = n.stops.map(function (g) {
              return new h(g[1]);
            });
          else {
            if (n && n.charAt && "#" === n.charAt()) {
              ...
              7 === r
                ? (q = [(n & 16711680) >> 16, (n & 65280) >> 8, n & 255, 1])
                : 4 === r &&
                  (q = [
                    ((n & 3840) >> 4) | ((n & 3840) >> 8),
                    ((n & 240) >> 4) | (n & 240),
        ...
        h.prototype.tweenTo = function (n, h) {
          ...
          r.length && B && B.length
            ? ((n = 1 !== r[3] || 1 !== B[3]),
              (h =
                (n ? "rgba(" : "rgb(") +
                Math.round(r[0] + (B[0] - r[0]) * (1 - h)) +
                "," +
                Math.round(r[1] + (B[1] - r[1]) * (1 - h)) +
                "," +
                Math.round(r[2] + (B[2] - r[2]) * (1 - h)) +
                (n ? "," + (r[3] + (B[3] - r[3]) * (1 - h)) : "") +
                ")"))
            : (h = n.input || "none");
          return h;
      ...
      h = (function () {
        ...
        h.prototype.update = function () {
          ...
          if (this[n + "Setter"]) this[n + "Setter"]();
            ...
            h.attr
              ? h.element && h.attr(n, B, null, !0)
              : (h.style[n] = B + this.unit);
          r && r.call(h, B, this);
        };
        h.prototype.run = function (h, G, B) {
          var r = this,
            ...
            H = function () {
              for (var v = 0; v < n.timers.length; v++)
                n.timers[v]() || n.timers.splice(v--, 1);
              n.timers.length && D(H);
            };
          h !== G || this.elem["forceAnimate:" + this.prop]
        ...
        h.prototype.step = function (h) {
          ...
          if (r.attr && !r.element) h = !1;
            ...
            (this.pos = B.easing((n - this.startTime) / g)),
        ...
        h.prototype.strokeSetter = function () {
          this.elem.attr(
            this.prop,
            n.color(this.start).tweenTo(n.color(this.end), this.pos),
            null,
            !0
          );
        };
  ...
  O(
    ...
    [q["Core/Animation/Fx.js"], q["Core/Globals.js"], q["Core/Utilities.js"]],
    function (n, h, q) {
      var L = q.defined,
        y = q.getStyle,
        F = q.isArray,
      ...
      var g = (h.animObject = function (u) {
          return G(u)
            ? h.merge({ duration: 500, defer: 0 }, u)
            : { duration: u ? 500 : 0, defer: 0 };
        }),
        D = (h.getDeferredAnimation = function (u, v, p) {
          ...
          u.renderer.forExport && (c = 0);
          return { defer: Math.max(0, c - e), duration: Math.min(c, e) };
        }),
        H = (h.animate = function (u, g, p) {
          ...
          if (!G(p)) {
            var b = arguments;
            p = { duration: b[2], easing: b[3], complete: b[4] };
          }
          ...
          r(g, function (b, a) {
            ...
            e = null;
            "d" === a && F(g.d)
              ? ((f.paths = f.initPath(u, u.pathArray, g.d)),
                (f.toD = g.d),
                (k = 0),
                (e = 1))
              : u.attr
              ? (k = u.attr(a))
              : ((k = parseFloat(y(u, a)) || 0), "opacity" !== a && (c = "px"));
            e || (e = b);
        ...
        v = (h.stop = function (v, g) {
          for (var p = h.timers.length; p--; )
            h.timers[p].elem !== v ||
              (g && g !== h.timers[p].prop) ||
              (h.timers[p].stopped = !0);
        });
      return {
        animate: H,
        animObject: g,
  ...
  O(
    ...
    [
      q["Core/Animation/AnimationUtilities.js"],
      q["Core/Color/Color.js"],
      q["Core/Globals.js"],
      q["Core/Utilities.js"],
    ],
    function (n, h, q, z) {
      ...
      n = (function () {
        ...
        I.prototype._defaultGetter = function (a) {
          a = K(
            this[a + "Value"],
            this[a],
        ...
        I.prototype.align = function (a, d, t) {
          ...
          if (a) {
            if (
              ((this.alignOptions = a), (this.alignByTranslate = d), !t || x(t))
            )
              (this.alignTo = b = t || "renderer"),
                c(e, this),
                e.push(this),
                (t = void 0);
          } else
        ...
        I.prototype.alignSetter = function (a) {
          ...
          d[a] &&
            ((this.alignValue = a),
            this.element.setAttribute("text-anchor", d[a]));
        };
        I.prototype.animate = function (a, d, t) {
          ...
          0 !== c.duration
            ...
            : (this.attr(a, void 0, t),
              C(
                a,
                function (d, t) {
                  c.step && c.step.call(this, d, { prop: t, pos: 1 });
                },
                this
              ));
          return this;
        ...
        I.prototype.applyTextOutline = function (a) {
          ...
          if ((t = a[0]) && "none" !== t && q.svg) {
            ...
            a.forEach(function (a, l) {
              0 === l &&
                (a.setAttribute("x", d.getAttribute("x")),
                (l = d.getAttribute("y")),
                a.setAttribute("y", l || 0),
                null === l && d.setAttribute("y", 0));
              l = a.cloneNode(!0);
              u(c && !m ? a : l, {
        ...
        I.prototype.attr = function (a, d, t, b) {
          ...
          "string" === typeof a
            ? (l = (this[a + "Getter"] || this._defaultGetter).call(this, a, c))
            : (C(
                a,
                function (d, t) {
                  J = !1;
                  ...
                  this.symbolName &&
                    -1 !== w.indexOf(t) &&
                    (f || (this.symbolAttr(a), (f = !0)), (J = !0));
                  !this.rotation ||
                    ("x" !== t && "y" !== t) ||
                    (this.doTransform = !0);
                  J ||
                    ((e = this[t + "Setter"] || this._defaultSetter),
                    e.call(this, d, t, c),
                    !this.styledMode &&
                      this.shadows &&
        ...
        I.prototype.complexColor = function (a, d, t) {
          ...
          f(this.renderer, "complexColor", { args: arguments }, function () {
            a.radialGradient
              ? (e = "radialGradient")
              : a.linearGradient && (e = "linearGradient");
            if (e) {
              w = a[e];
              p = c.gradients;
              v = a.stops;
              ...
              if (p[K]) m = p[K].attr("id");
                ...
                v.forEach(function (d) {
                  ...
                  d = c
                    .createElement("stop")
                    .attr({ offset: d[0], "stop-color": u, "stop-opacity": g })
                    .add(f);
                  f.stops.push(d);
                });
              }
          ...
          if (f) {
            ...
            if (a)
              if (null === a.width || "auto" === a.width) delete this.textWidth;
                ...
                var w = (this.textWidth = T(a.width));
            this.styles = a;
        ...
        I.prototype.dashstyleSetter = function (a) {
          ...
          if ((a = a && a.toLowerCase())) {
            var t = a
              ...
              .replace(/,$/, "")
              .split(",");
            for (a = t.length; a--; ) t[a] = "" + T(t[a]) * K(d, NaN);
        ...
        I.prototype.destroy = function () {
          ...
          if (a.clipPath && f) {
            ...
            [].forEach.call(
              ...
              function (d) {
                -1 < d.getAttribute("clip-path").indexOf(l.element.id) &&
        ...
        I.prototype.getBBox = function (a, d) {
          ...
          var C = b.styledMode
            ? c && I.prototype.getStyle.call(c, "font-size")
            : f && f.fontSize;
          if (k(w)) {
            var v = w.toString();
          ...
          if (!t) {
            if (p || b.forExport) {
              ...
              if (!t || 0 > t.width) t = { width: 0, height: 0 };
              ...
              p &&
                (t.height = b =
                  { "11px,17": 14, "13px,20": 16 }[
                    f && f.fontSize + "," + Math.round(b)
                  ] || b),
              d &&
                ((f = d * G),
                (t.width =
                  Math.abs(b * Math.sin(f)) + Math.abs(a * Math.cos(f))),
                (t.height =
                  Math.abs(b * Math.cos(f)) + Math.abs(a * Math.sin(f)))));
            if (v && 0 < t.height) {
        ...
        I.prototype.init = function (a, d) {
          this.element =
            "span" === d ? A(d) : B.createElementNS(this.SVG_NS, d);
          this.renderer = a;
          f(this, "afterInit");
        };
            ...
            ? ((c.ontouchstart = function (d) {
              ...
              (c.ontouchend = function (a) {
                (t &&
                  4 <=
                    Math.sqrt(
                      Math.pow(t - a.changedTouches[0].clientX, 2) +
                        Math.pow(b - a.changedTouches[0].clientY, 2)
                    )) ||
                  d.call(c, a);
                f = !0;
        ...
        I.prototype.removeClass = function (a) {
          return this.attr(
            "class",
            ("" + this.attr("class"))
              .replace(x(a) ? new RegExp("(^| )" + a + "( |$)") : a, " ")
              .replace(/ +/g, " ")
              .trim()
          );
        };
        I.prototype.removeTextOutline = function (a) {
          for (var d = a.length, t; d--; )
            (t = a[d]),
              "highcharts-text-outline" === t.getAttribute("class") &&
                c(a, this.element.removeChild(t));
        };
        I.prototype.safeRemoveChild = function (a) {
          var d = a.parentNode;
          d && d.removeChild(a);
        };
        I.prototype.setRadialReference = function (a) {
          ...
          d &&
            d.radAttr &&
            d.animate(this.renderer.getRadialAttr(a, d.radAttr));
          return this;
        };
        I.prototype.setTextPath = function (b, d) {
          ...
          if (b && d && d.enabled) {
            l && null === l.element.parentNode
              ...
              : l &&
                this.removeTextOutline.call(
                  l.parentGroup,
                  [].slice.call(t.getElementsByTagName("tspan"))
                );
            this.options &&
              this.options.padding &&
              (x.dx = -this.options.padding);
            l ||
            ...
            (d = b.element.getAttribute("id")) ||
              b.element.setAttribute("id", (d = N()));
            if (e)
              for (b = t.getElementsByTagName("tspan"); b.length; )
                b[0].setAttribute("y", 0),
                  a(x.dx) && b[0].setAttribute("x", -x.dx),
                  w.appendChild(b[0]);
            f && l && l.add({ element: this.text ? this.text.element : t });
            w.setAttributeNS(
        ...
        I.prototype.shadow = function (a, d, t) {
          ...
          if (!x) this.destroyShadows();
            ...
            for (k = 1; k <= x.width; k++) {
              ...
              t &&
                (u(p, "height", Math.max(u(p, "height") - v, 0)),
                (p.cutHeight = v));
              d
                ? d.element.appendChild(p)
        ...
        I.prototype.strokeSetter = function (a, d, t) {
          ...
          this.stroke && this["stroke-width"]
            ? (I.prototype.fillSetter.call(this, this.stroke, "stroke", t),
              t.setAttribute("stroke-width", this["stroke-width"]),
              (this.hasStroke = !0))
            : "stroke-width" === d && 0 === a && this.hasStroke
        ...
        I.prototype.titleSetter = function (a) {
          ...
          d ||
            ((d = B.createElementNS(this.SVG_NS, "title")),
            ...
            : f &&
              a.push(
                "rotate(" +
                  f +
                  " " +
                  K(this.rotationOriginX, e.getAttribute("x"), 0) +
                  " " +
                  K(this.rotationOriginY, e.getAttribute("y") || 0) +
                  ")"
              );
        ...
        I.prototype.zIndexSetter = function (a, d) {
          ...
          k(a)
            ? (f.setAttribute("data-z-index", a),
              (a = +a),
              this[d] === a && (e = !1))
            : k(this[d]) && f.removeAttribute("data-z-index");
          this[d] = a;
          if (e) {
            (a = this.zIndex) && b && (b.handleZ = !0);
            d = c.childNodes;
            for (x = d.length - 1; 0 <= x && !l; x--) {
              b = d[x];
              e = b.getAttribute("data-z-index");
              var p = !k(e);
              if (b !== f)
                if (0 > a && p && !t && !x) c.insertBefore(f, d[x]), (l = !0);
                else if (T(e) <= a || (p && (!k(a) || 0 <= a)))
                  c.insertBefore(f, d[x + 1] || null), (l = !0);
            }
  ...
  O(
    ...
    [q["Core/Renderer/SVG/SVGElement.js"], q["Core/Utilities.js"]],
    function (n, h) {
      var q =
          (this && this.__extends) ||
          (function () {
            var h = function (r, m) {
              h =
                ...
                function (g, m) {
                  for (var r in m) m.hasOwnProperty(r) && (g[r] = m[r]);
                };
              return h(r, m);
            };
            return function (r, m) {
      ...
      return (function (h) {
        function r(m, g, D, H, v, u, A, p, k, c) {
          ...
          e.text = m.text("", 0, 0, p).attr({ zIndex: 1 });
          if ("string" === typeof v) {
            var f = /^url\((.*?)\)$/.test(v);
        ...
        r.prototype.anchorXSetter = function (m, g) {
          ...
          this.boxAttr(
            g,
            Math.round(m) - this.getCrispAdjust() - this.xSetting
          );
        };
        ...
        r.prototype.css = function (m) {
          if (m) {
            ...
            if ("width" in g || h)
              this.updateBoxSize(), h && this.updateTextPadding();
          }
        ...
        r.prototype.on = function (m, g) {
          ...
          if (v) {
            var u = function (u) {
              (("mouseenter" === m || "mouseleave" === m) &&
                u.relatedTarget instanceof Element &&
                (r.element.contains(u.relatedTarget) ||
                  v.element.contains(u.relatedTarget))) ||
                g.call(r.element, u);
            };
            v.on(m, u);
          }
        ...
        r.prototype.onAdd = function () {
          var m = this.textStr;
          this.text.add(this);
          this.attr({ text: z(m) ? m : "", x: this.x, y: this.y });
          this.box &&
            z(this.anchorX) &&
        ...
        r.prototype.paddingSetter = function (m) {
          z(m) &&
            m !== this.padding &&
            ((this.padding = m), this.updateTextPadding());
        };
        r.prototype.paddingLeftSetter = function (m) {
          z(m) &&
            m !== this.paddingLeft &&
            ((this.paddingLeft = m), this.updateTextPadding());
        };
        ...
        r.prototype.shadow = function (m) {
          m &&
            !this.renderer.styledMode &&
            (this.updateBoxSize(), this.box && this.box.shadow(m));
          return this;
        };
        ...
        r.prototype.textSetter = function (m) {
          "undefined" !== typeof m && this.text.attr({ text: m });
          this.updateBoxSize();
        ...
        r.prototype.updateBoxSize = function () {
          ...
          this.baselineOffset =
            h +
            Math.min(
              this.renderer.fontMetrics(m && m.fontSize, this.text).b,
              v.height || Infinity
            );
          this.needsBox &&
            (this.box ||
              ...
              m.add(this),
              (m = this.getCrispAdjust()),
              (g.x = m),
              (g.y = (this.baseline ? -this.baselineOffset : 0) + m)),
        ...
        r.prototype.updateTextPadding = function () {
          ...
          if (r !== m.x || g !== m.y)
            m.attr("x", r),
              m.hasBoxWidthChanged &&
                ((this.bBox = m.getBBox(!0)), this.updateBoxSize()),
              "undefined" !== typeof g && m.attr("y", g);
          m.x = r;
          m.y = g;
        };
        ...
        r.prototype.ySetter = function (m) {
          this.ySetting = this.y = Math.round(m);
          this.attr("translateY", this.ySetting);
        };
        r.emptyBBox = { width: 0, height: 0, x: 0, y: 0 };
        r.textProps =
  ...
  O(
    ...
    [
      q["Core/Color/Color.js"],
      q["Core/Globals.js"],
      q["Core/Renderer/SVG/SVGElement.js"],
      q["Core/Renderer/SVG/SVGLabel.js"],
      q["Core/Utilities.js"],
    ],
    function (n, h, q, z, y) {
      var F = y.addEvent,
      ...
      var K = h.svg,
        ...
        I = (function () {
          ...
          w.prototype.init = function (d, t, b, c, f, l, e) {
            ...
            d.appendChild(c);
            L(d, "dir", "ltr");
            -1 === d.innerHTML.indexOf("xmlns") && L(c, "xmlns", this.SVG_NS);
            this.isSVG = !0;
            this.box = c;
            this.boxWrapper = J;
            this.alignedObjects = [];
            this.url =
              (x || C) && a.getElementsByTagName("base").length
                ? N.location.href
                    .split("#")[0]
                    .replace(/<[^>]*>/g, "")
                    .replace(/([\('\)])/g, "\\$1")
            ...
            this.createElement("desc")
              .add()
              .element.appendChild(
                a.createTextNode("Created with Highcharts 8.2.2")
              );
            ...
            x &&
              ...
              t(),
              (this.unSubPixelFix = F(N, "resize", t)));
          };
          w.prototype.definition = function (d) {
            function t(d, c) {
              ...
              e(d).forEach(function (d) {
                ...
                l.add(c || b.defs);
                d.textContent &&
                  l.element.appendChild(a.createTextNode(d.textContent));
                t(d.children || [], l);
                f = l;
              });
              return f;
          ...
          w.prototype.getRadialAttr = function (d, a) {
            return {
              ...
              w = function (a, l) {
                ...
                if ("undefined" === typeof E[l])
                  if (t.getSubStringLength)
                    ...
                    J.getSpanWidth &&
                      (C(e(b || c, a)), (E[l] = f + J.getSpanWidth(d, t)));
                return E[l];
              },
              v;
            d.rotation = 0;
            ...
            if ((v = f + u > l)) {
              for (; P <= Q; )
                (p = Math.ceil((P + Q) / 2)),
                  c && (x = e(c, p)),
                  (u = w(p, x && x.length - 1)),
                  P === Q ? (P = Q + 1) : u > l ? (Q = p - 1) : (P = p);
              0 === Q
                ? C("")
                : (b && Q === b.length - 1) || C(x || e(b || c, p));
            }
            c && c.splice(0, p);
            d.actualWidth = u;
            d.rotation = k;
          ...
          w.prototype.buildText = function (d) {
            ...
            var H = function (d) {
                var a;
                b.styledMode ||
                  (a = /(px|em)$/.test(d && d.style.fontSize)
                    ? d.style.fontSize
                    : h || b.style.fontSize || 12);
                return g
                  ? c(g)
                  : b.fontMetrics(a, d.getAttribute("style") ? d : t).h;
              },
              D = function (d, a) {
                p(b.escapes, function (t, b) {
                  (a && -1 !== a.indexOf(t)) ||
                    (d = d.toString().replace(new RegExp(t, "g"), b));
                });
                return d;
              },
              n = function (d, a) {
                ...
                if (
                  ...
                  return (d = d.substring(t + 1)), d.substring(0, d.indexOf(a));
              },
              q = /<br.*?>/g;
            var R = [l, m, r, g, A, h, v].join();
            if (R !== d.textCache) {
              for (d.textCache = R; I--; ) t.removeChild(x[I]);
              e || A || m || v || (-1 !== l.indexOf(" ") && (!r || q.test(l)))
                ? (w && w.appendChild(t),
                  e
                    ? ((l = b.styledMode
                        ? l
                    ...
                    k.forEach(function (c) {
                      if ("" !== c || 1 === k.length) {
                        ...
                        if (
                          ...
                          !f &&
                          -1 ===
                            Q.split(":")[0].toLowerCase().indexOf("javascript")
                        ) {
                          var w = a.createElementNS(b.SVG_NS, "a");
                          L(w, "href", Q);
                          L(P, "class", "highcharts-anchor");
                          w.appendChild(P);
                          b.styledMode || B(P, { cursor: "pointer" });
                        }
                  ...
                  m &&
                    E &&
                    d.attr("title", D(d.textStr || "", ["&lt;", "&gt;"])),
                  w && w.removeChild(t),
                  u(A) && d.applyTextOutline && d.applyTextOutline(A))
                : t.appendChild(a.createTextNode(D(l)));
            }
          };
          ...
          w.prototype.button = function (d, a, b, c, f, l, e, k, x, p) {
            ...
            P || t.attr(f).css(g({ cursor: "default" }, Q));
          ...
          w.prototype.arc = function (d, a, b, c, f, l) {
            v(d)
              ? ((c = d), (a = c.y), (b = c.r), (d = c.x))
              : (c = { innerR: c, start: f, end: l });
          ...
          w.prototype.rect = function (d, a, b, c, f, l) {
            ...
            d = v(d)
              ...
              : "undefined" === typeof d
              ? {}
              : { x: d, y: a, width: Math.max(b, 0), height: Math.max(c, 0) };
            this.styledMode ||
              ("undefined" !== typeof l &&
                ((d.strokeWidth = l), (d = t.crisp(d))),
              (d.fill = "none"));
            f && (d.r = f);
          ...
          w.prototype.g = function (d) {
            ...
            return d ? a.attr({ class: "highcharts-" + d }) : a;
          };
            ...
            var t = { preserveAspectRatio: "none" },
              e = function (d, a) {
                d.setAttributeNS
                  ...
                  : d.setAttribute("hc-svg-href", a);
              },
              J = function (a) {
                e(k.element, d);
                l.call(k, a);
              };
            1 < arguments.length && g(t, { x: a, y: b, width: c, height: f });
          ...
          w.prototype.symbol = function (d, t, c, f, l, e) {
            ...
            if (E) {
              ...
              g(w, { symbolName: p, x: t, y: c, width: f, height: l });
              e && g(w, e);
            } else if (P) {
              var C = d.match(x)[1];
              w = this.image(C);
                ...
                w[d + "Setter"] = function (d, a) {
                  ...
                  r(b) &&
                    ...
                    this.alignByTranslate ||
                      ((t[c] = ((this[a] || 0) - b) / 2), this.attr(t)));
                };
              });
              r(t) && w.attr({ x: t, y: c });
              w.isImg = !0;
              r(w.imgwidth) && r(w.imgheight)
                ? v()
                : (w.attr({ width: 0, height: 0 }),
                  G("img", {
                    onload: function () {
                      ...
                      R[C] = { width: this.width, height: this.height };
                      w.imgwidth = this.width;
                      w.imgheight = this.height;
                      w.element && v();
                      this.parentNode && this.parentNode.removeChild(this);
                      J.imgCount--;
                      if (!J.imgCount && d && !d.hasLoaded) d.onload();
                    },
                    src: C,
                  }),
                  this.imgCount++);
          ...
          w.prototype.clipRect = function (d, a, b, c) {
            var t = f() + "-",
              l = this.createElement("clipPath").attr({ id: t }).add(this.defs);
          ...
          w.prototype.text = function (d, a, b, c) {
            ...
            if (c && (this.allowHTML || !this.forExport))
              return this.html(d, a, b);
            t.x = Math.round(a || 0);
            b && (t.y = Math.round(b));
            r(d) && (t.text = d);
            d = this.createElement("text").attr(t);
            c ||
              (d.xSetter = function (d, a, t) {
          ...
          w.prototype.fontMetrics = function (d, a) {
            d =
              (!this.styledMode && /px/.test(d)) || !N.getComputedStyle
                ? d ||
            ...
            return { h: a, b: Math.round(0.8 * a), f: d };
          };
          ...
          w.prototype.pathToSegments = function (d) {
            for (
              ...
              u(b[0]) &&
                H(d[f]) &&
                b.length === c[b[0].toUpperCase()] &&
                d.splice(f, 0, b[0].replace("M", "L").replace("m", "l")),
                "string" === typeof d[f] &&
                  (b.length && a.push(b.slice(0)), (b.length = 0)),
                b.push(d[f]);
            a.push(b.slice(0));
            return a;
          };
      ...
      I.prototype.symbols = {
        ...
        "triangle-down": function (a, d, t, b) {
          return [["M", a, d], ["L", a + t, d], ["L", a + t / 2, d + b], ["Z"]];
        },
        diamond: function (a, d, t, b) {
          return [
            ["M", a + t / 2, d],
            ["L", a + t, d + b / 2],
            ["L", a + t / 2, d + b],
        ...
        arc: function (a, d, t, b, c) {
          ...
          if (c) {
            var l = c.start || 0,
              ...
              J = c.r || t;
            t = c.r || b || t;
            var x = 0.001 > Math.abs(e - l - 2 * Math.PI);
            e -= 0.001;
            b = c.innerR;
            x = k(c.open, x);
            var p = Math.cos(l),
              ...
              P = Math.cos(e),
              w = Math.sin(e);
            l = k(c.longArc, 0.001 > e - l - Math.PI ? 0 : 1);
            f.push(
              ["M", a + J * p, d + t * E],
              ["A", J, t, 0, l, k(c.clockwise, 1), a + J * P, d + t * w]
            );
            r(b) &&
              f.push(
                x ? ["M", a + b * P, d + b * w] : ["L", a + b * P, d + b * w],
                [
                  "A",
                  b,
                  b,
    ...
    function (n, h, q) {
      ...
      F(h.prototype, {
        htmlCss: function (r) {
          ...
          r &&
            "ellipsis" === r.textOverflow &&
            ((r.whiteSpace = "nowrap"), (r.overflow = "hidden"));
        ...
        htmlUpdateTransform: function () {
          if (this.added) {
            var r = this.renderer,
              ...
              A = { left: 0, center: 0.5, right: 1 }[u],
              p = this.styles,
              k = p && p.whiteSpace;
            L(m, { marginLeft: g, marginTop: h });
            !r.styledMode &&
              this.shadows &&
              this.shadows.forEach(function (b) {
                L(b, { marginLeft: g + 1, marginTop: h + 1 });
              });
            this.inverted &&
              [].forEach.call(m.childNodes, function (b) {
                r.invertChild(b, m);
              });
            if ("SPAN" === m.tagName) {
              p = this.rotation;
              var c = this.textWidth && G(this.textWidth),
                e = [p, u, m.innerHTML, this.textWidth, this.textAlign].join(),
                f;
              (f = c !== this.oldTextWidth) &&
                !(f = c > this.oldTextWidth) &&
                ((f = this.textPxLength) ||
                  (L(m, { width: "", whiteSpace: k || "nowrap" }),
                  (f = m.offsetWidth)),
                (f = f > c));
              f &&
              (/[ \-]/.test(m.textContent || m.innerText) ||
                "ellipsis" === m.style.textOverflow)
                ? (L(m, {
                    width: c + "px",
                    display: "block",
                    whiteSpace: k || "normal",
              ...
              e !== this.cTT &&
                ((k = r.fontMetrics(m.style.fontSize, m).b),
                !y(p) ||
                  (p === (this.oldRotation || 0) && u === this.oldAlign) ||
                  this.setSpanRotation(p, A, k),
                this.getSpanCorrection(
                  (!y(p) && this.textPxLength) || m.offsetWidth,
                  k,
                  A,
                  p,
                  u
        ...
        setSpanRotation: function (r, m, g) {
          ...
          h[H + (B ? "Origin" : "-origin")] = h.transformOrigin =
            100 * m + "% " + g + "px";
          L(this.element, h);
        },
    ...
    function (n, h, q, z) {
      ...
      m(q.prototype, {
        getTransformKey: function () {
          return L && !/Edge/.test(G.navigator.userAgent)
            ? "-ms-transform"
            : M
            ? "-webkit-transform"
            : y
        ...
        html: function (n, H, v) {
          ...
          u.attr({ text: n, x: Math.round(H), y: Math.round(v) }).css({
            position: "absolute",
          });
          p.styledMode ||
            u.css({
                ...
                if (!l) {
                  ...
                  b.reverse().forEach(function (a) {
                    ...
                    m(a, {
                      ...
                      on: function () {
                        b[0].div &&
                          u.on.apply({ element: b[0].div }, arguments);
                        return a;
                      },
                      translateXSetter: e,
                      translateYSetter: e,
    ...
    function (n, h) {
      ...
      h = (function () {
        ...
        h.prototype.addLabel = function () {
          ...
          var C, r;
          if (u.dateTime && l) {
            var h = p.time.resolveDTLFormat(
              m.dateTimeLabelFormats[
                (!m.grid && l.higherRanks[f]) || l.unitName
              ]
            );
            var n = h.main;
          }
          ...
          if ((r = h && h.list))
            v.shortenLabel = function () {
              for (C = 0; C < r.length; C++)
                if (
                  (E.attr({
                    text: u.labelFormatter.call(
                      M(v.formatCtx, { dateTimeLabelFormat: r[C] })
                    ),
                  }),
                  E.getBBox().width < u.getSlotWidth(v) - 2 * g(b.padding, 5))
                )
                  return;
              E.attr({ text: "" });
            };
          ...
          y(E) || v.movedLabel
            ...
            : ((v.label = E = v.createLabel({ x: 0, y: 0 }, m, b)),
              (v.rotation = 0));
        };
        h.prototype.createLabel = function (v, u, g) {
          ...
          if (
            (v =
              y(u) && g.enabled
                ? k.renderer.text(u, v.x, v.y, g.useHTML).add(p.labelGroup)
                : null)
          )
            k.styledMode || v.css(r(g.style)),
        ...
        h.prototype.getPosition = function (v, u, g, p) {
          var k = this.axis,
            c = k.chart,
            e = (p && c.oldChartHeight) || c.chartHeight;
          v = {
            x: v
              ? z(k.translate(u + g, null, null, p) + k.transB)
              : k.left +
                k.offset +
                (k.opposite
                  ? ((p && c.oldChartWidth) || c.chartWidth) - k.right - k.left
                  : 0),
            y: v
              ? e - k.bottom + k.offset - (k.opposite ? k.height : 0)
              : z(e - k.translate(u + g, null, null, p) - k.transB),
          };
          v.y = q(v.y, -1e5, 1e5);
          G(this, "afterGetPosition", { pos: v });
          return v;
        };
          ...
          y(C) ||
            (C =
              0 === b.side
                ...
                : 2 === b.side
                ? E.y + 8
                : Math.cos(g.rotation * D) *
                  (E.y - g.getBBox(!1, 0).height / 2));
        ...
        h.prototype.handleOverflow = function (v) {
          ...
          c = g(
            u.labelRight,
            Math.max(u.isRadial ? 0 : u.pos + u.len, k - c[1])
          );
          var f = this.label,
            b = this.rotation,
            ...
            r,
            h = {};
          if (b || "justify" !== g(m.overflow, "justify"))
            0 > b && p - l * a < e
              ? (r = Math.round(p / Math.cos(b * D) - e))
              : 0 < b &&
                p + l * a > c &&
                (r = Math.round((k - p) / Math.cos(b * D)));
          else if (
            ((k = p + (1 - l) * a),
            p - l * a < e
              ? (E = v.x + E * (1 - l) - e)
            ...
            E < x &&
              "center" === u.labelAlign &&
              (v.x += C * (x - E - l * (x - Math.min(a, E)))),
            a > E || (u.autoRotation && (f.styles || {}).width))
          )
            r = E;
          r &&
            (this.shortenLabel
              ? this.shortenLabel()
              : ((h.width = Math.floor(r) + "px"),
                (m.style || {}).textOverflow || (h.textOverflow = "ellipsis"),
                f.css(h)));
        };
        h.prototype.moveLabel = function (v, u) {
          var g = this,
            ...
            e = c.reversed;
          p && p.textStr === v
            ? ((g.movedLabel = p), (k = !0), delete g.label)
            : m(c.ticks, function (b) {
                k ||
                  b.isNew ||
                  b === g ||
                  !b.label ||
          ...
          if (!k && (g.labelPos || p)) {
            ...
            g.movedLabel = g.createLabel({ x: p, y: c }, v, u);
        ...
        h.prototype.renderGridLine = function (v, u, m) {
          ...
          c ||
            (p.chart.styledMode ||
              ((e.stroke = C), (e["stroke-width"] = E), k && (e.dashstyle = k)),
            b || (e.zIndex = 1),
            v && (u = 0),
            (this.gridLine = c =
              a
          ...
          if (
            ...
            c[v || this.isNew ? "attr" : "animate"]({ d: m, opacity: u });
        };
            ...
            a &&
              ((this.mark = l =
                c
                  ...
                  .add(p.axisGroup)),
              p.chart.styledMode || l.attr({ stroke: k, "stroke-width": E })),
            l[a ? "attr" : "animate"]({
        ...
        h.prototype.renderLabel = function (v, u, m, p) {
          ...
          f &&
            B(x) &&
            ((f.xy = v = this.getLabelPosition(x, v, f, c, b, k, p, l)),
            (this.isFirst && !this.isLast && !g(e.showFirstLabel, 1)) ||
            (this.isLast && !this.isFirst && !g(e.showLastLabel, 1))
              ? (a = !1)
              : !c ||
                b.step ||
                b.rotation ||
            ...
            a && B(v.y)
              ? ((v.opacity = m),
                f[this.isNewLabel ? "attr" : "animate"](v),
                (this.isNewLabel = !1))
        ...
        h.prototype.replaceMovedLabel = function () {
          ...
          if (v && !this.isNew) {
            ...
            v.animate({ x: p, y: m, opacity: 0 }, void 0, v.destroy);
            delete this.label;
          }
          g.isDirty = !0;
  ...
  O(
    ...
    function (n, h) {
      ...
      h = (function () {
        ...
        h.prototype.makeTime = function (g, m, h, p, k, c) {
          if (this.useUTC) {
            ...
            f !== b
              ? (e += b - f)
              : f - 36e5 !== this.getTimezoneOffset(e - 36e5) ||
                n.isSafari ||
                (e -= 36e5);
          } else
            e = new this.Date(
        ...
        h.prototype.timezoneOffsetFunction = function () {
          ...
          if (m.timezone) {
            if (r)
              return function (p) {
                return 6e4 * -r.tz(p, m.timezone).utcOffset();
              };
            z(25);
          }
        ...
        h.prototype.dateFormat = function (g, m, h) {
          ...
          if (!q(m) || isNaN(m))
            return (
              (null === (p = n.defaultOptions.lang) || void 0 === p
                ? void 0
                : p.invalidDate) || ""
            );
          g = r(g, "%Y-%m-%d %H:%M:%S");
          ...
          G(p, function (a, b) {
            for (; -1 !== g.indexOf("%" + b); )
              g = g.replace(
                "%" + b,
                "function" === typeof a ? a.call(k, m) : a
              );
          });
          return h ? g.substr(0, 1).toUpperCase() + g.substr(1) : g;
        };
        h.prototype.resolveDTLFormat = function (g) {
          return F(g, !0)
            ? g
            : ((g = m(g)), { main: g[0], from: g[1], to: g[2] });
        };
        h.prototype.getTimeTicks = function (m, u, h, p) {
          ...
          if (q(u)) {
            k.set(
              "Milliseconds",
              f,
              b >= g.second ? 0 : l * Math.floor(k.get("Milliseconds", f) / l)
            );
            b >= g.second &&
              k.set(
                "Seconds",
                f,
                b >= g.minute ? 0 : l * Math.floor(k.get("Seconds", f) / l)
              );
            b >= g.minute &&
              k.set(
                "Minutes",
                f,
                b >= g.hour ? 0 : l * Math.floor(k.get("Minutes", f) / l)
              );
            b >= g.hour &&
              k.set(
                "Hours",
                f,
                b >= g.day ? 0 : l * Math.floor(k.get("Hours", f) / l)
              );
            b >= g.day &&
              k.set(
                "Date",
                ...
                b >= g.month
                  ? 1
                  : Math.max(1, l * Math.floor(k.get("Date", f) / l))
              );
            if (b >= g.month) {
              k.set(
                "Month",
                f,
                b >= g.year ? 0 : l * Math.floor(k.get("Month", f) / l)
              );
            ...
            b === g.week &&
              ((x = k.get("Day", f)),
              k.set("Date", f, k.get("Date", f) - x + p + (x < p ? -7 : 0)));
            x = k.get("FullYear", f);
            p = k.get("Month", f);
            var E = k.get("Date", f),
              C = k.get("Hours", f);
              ...
              c.push(u),
                (u =
                  b === g.year
                    ...
                    : !a || (b !== g.day && b !== g.week)
                    ? a && b === g.hour && 1 < l
                      ? k.makeTime(x, p, E, C + f * l)
                      : u + b * l
                    : k.makeTime(x, p, E + f * l * (b === g.day ? 1 : 7))),
                f++;
            c.push(u);
            b <= g.hour &&
              1e4 > c.length &&
              c.forEach(function (a) {
                0 === a % 18e5 &&
                  "000000000" === k.dateFormat("%H%M%S%L", a) &&
                  (e[a] = "day");
              });
          }
          c.info = y(m, { higherRanks: e, totalRange: b * l });
          return c;
        };
        return h;
      })();
    ...
    function (n, h, q, z, y, F) {
      ...
      n = (function () {
        ...
        w.prototype.init = function (d, a) {
          ...
          A(this, "init", { userOptions: a });
          b.opposite = a.opposite;
          b.side =
            a.side || (b.horiz ? (b.opposite ? 0 : 2) : b.opposite ? 1 : 3);
          b.setOptions(a);
          var c = this.options,
            f = c.type;
          ...
          b.crosshair = E(
            c.crosshair,
            T(d.options.tooltip.crosshairs)[t ? 0 : 1],
            !1
          );
          a = b.options.events;
          -1 === d.axes.indexOf(b) &&
            (t ? d.axes.splice(d.xAxis.length, 0, b) : d.axes.push(b),
            d[b.coll].push(b));
          b.series = b.series || [];
          d.inverted &&
            !b.isZAxis &&
            t &&
            "undefined" === typeof b.reversed &&
            (b.reversed = !0);
        ...
        w.prototype.setOptions = function (d) {
          ...
          A(this, "afterSetOptions", { userOptions: d });
        };
            ...
            for (; x-- && "undefined" === typeof m; )
              (b = Math.pow(e, x + 1)),
                d >= b &&
                  ...
                  (m = C(a / b, -1) + k[x]);
          "undefined" === typeof m &&
            (m = 1e4 <= Math.abs(a) ? C(a, -1) : C(a, -1, void 0, ""));
          return m;
        };
              ...
              if (t.visible || !a.options.chart.ignoreHiddenSeries) {
                ...
                if (d.isXAxis) {
                  if (((c = t.xData), c.length)) {
                    c = d.logarithmic ? c.filter(d.validatePositiveValue) : c;
                    b = t.getXExtremes(c);
                    var e = b.min;
                    var k = b.max;
                    f(e) ||
                      ...
                      (k = b.max));
                    c.length &&
                      ((d.dataMin = Math.min(E(d.dataMin, e), e)),
                      (d.dataMax = Math.max(E(d.dataMax, k), k)));
                  }
                } else if (
                  ((t = t.applyExtremes()),
                  f(t.dataMin) &&
                  ...
                  f(t.dataMax) &&
                    ...
                    (d.dataMax = Math.max(E(d.dataMax, k), k))),
                  D(l) && (d.threshold = l),
                  !c.softThreshold || d.positiveValuesOnly)
                )
                  d.softThreshold = !1;
              }
            });
        ...
        w.prototype.translate = function (d, a, b, c, l, e) {
          ...
          l =
            (t.isOrdinal ||
              (t.brokenAxis && t.brokenAxis.hasBreaks) ||
              (t.logarithmic && l)) &&
            t.lin2val;
          x || (x = t.transA);
          b && ((k *= -1), (J = t.len));
          ...
          a
            ? ((d = (d * k + J - p) / x + c), l && (d = t.lin2val(d)))
            : (l && (d = t.val2lin(d)),
              (d = f(c)
                ? k * (d - c) * x + J + k * p + (f(e) ? x * e : 0)
                : void 0));
          return d;
        };
        w.prototype.toPixels = function (d, a) {
          return (
            this.translate(d, !1, !this.horiz, null, !0) + (a ? 0 : this.pos)
          );
        };
        ...
        w.prototype.getPlotLinePath = function (d) {
          ...
          var b = this,
            ...
            v,
            h,
            r = (k && c.oldChartHeight) || c.chartHeight,
          ...
          A(this, "getPlotLinePath", d, function (d) {
            ...
            f(p)
              ? b.horiz
                ? ((u = e), (h = r - b.bottom), (w = v = a(w, l, l + b.width)))
                : ((w = l), (v = K - b.right), (u = h = a(u, e, e + b.height)))
              : ((N = !0), (C = !1));
            d.path =
              N && !C
                ? null
        ...
        w.prototype.getMinorTickInterval = function () {
          var d = this.options;
          return !0 === d.minorTicks
            ? E(d.minorTickInterval, "auto")
            : !1 === d.minorTicks
            ? null
            : d.minorTickInterval;
        };
        w.prototype.getMinorTickPositions = function () {
          ...
          if (e && e / b < this.len / 3) {
            ...
            if (k)
              this.paddedTicks.forEach(function (d, a, t) {
                a &&
                  c.push.apply(c, k.getLogTickPositions(b, t[a - 1], t[a], !0));
              });
            ...
            (D(d.min) || D(d.max)
              ...
              : (this.series.forEach(function (d) {
                  ...
                  for (l = x = d.xIncrement ? 1 : k.length - 1; 0 < l; l--)
                    if (
                      ((e = k[l] - k[l - 1]), "undefined" === typeof f || e < f)
                    )
                      f = e;
                }),
        ...
        w.prototype.nameToX = function (d) {
          ...
          "undefined" !== typeof l &&
            ((this.names[l] = d.name), (this.names.keys[d.name] = l));
          return l;
        };
        w.prototype.updateNames = function () {
          var d = this,
            a = this.names;
          0 < a.length &&
            (Object.keys(a.keys).forEach(function (d) {
              delete a.keys[d];
            }),
            (a.length = 0),
            ...
            (this.series || []).forEach(function (a) {
              ...
              if (!a.points || a.isDirtyData)
                (d.max = Math.max(d.max, a.xData.length - 1)),
                  a.processData(),
                  a.generatePoints();
        ...
        w.prototype.setAxisTranslation = function (d) {
          ...
          if (g || x || f) {
            var C = a.getClosest();
            k
              ? ((l = k.minPointOffset), (e = k.pointRangePadding))
              : a.series.forEach(function (d) {
                  var t = x
                      ? 1
                      : g
                      ? E(d.options.pointRange, C, 0)
                      : a.axisPointRange || 0,
                    c = d.options.pointPlacement;
                  f = Math.max(f, t);
                  if (!a.single || x)
                    (d = d.is("xrange") ? !g : g),
                      (l = Math.max(l, d && b(c) ? 0 : t / 2)),
                      (e = Math.max(e, d && "on" === c ? 0 : t));
                });
        ...
        w.prototype.setTickInterval = function (d) {
          ...
          if (p) {
            ...
            b.min = E(N, n, b.dataMin);
            b.max = E(I, H, b.dataMax);
          }
          l &&
            (b.positiveValuesOnly &&
              !d &&
              0 >= Math.min(b.min, E(b.dataMin, b.min)) &&
              v(10, 1, c),
            (b.min = g(l.log2lin(b.min), 16)),
            (b.max = g(l.log2lin(b.max), 16)));
          b.range &&
            D(b.max) &&
          ...
          !(
            ...
            D(b.max) &&
            (c = b.max - b.min) &&
            (!D(N) && m && (b.min -= c * m), !D(I) && C && (b.max += c * C));
          f(b.userMin) ||
            (f(e.softMin) && e.softMin < b.min && (b.min = N = e.softMin),
            f(e.floor) && (b.min = Math.max(b.min, e.floor)));
          f(b.userMax) ||
            (f(e.softMax) && e.softMax > b.max && (b.max = I = e.softMax),
            f(e.ceiling) && (b.max = Math.min(b.max, e.ceiling)));
          K &&
            D(b.dataMin) &&
            ((r = r || 0),
            !D(N) && b.min < r && b.dataMin >= r
              ? (b.min = b.options.minRange
                  ? Math.min(r, b.max - b.minRange)
                  : r)
              : !D(I) &&
                b.max > r &&
                b.dataMax <= r &&
                (b.max = b.options.minRange
                  ? Math.max(r, b.min + b.minRange)
                  : r));
          b.tickInterval =
            b.min === b.max ||
            ...
            "undefined" === typeof b.max
              ? 1
              : p && !w && u === b.linkedParent.options.tickPixelInterval
              ? (w = b.linkedParent.tickInterval)
              : E(
                  w,
                  this.tickAmount
                    ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1)
                    : void 0,
                  h ? 1 : ((b.max - b.min) * u) / Math.max(b.len, u)
                );
          x &&
            !d &&
        ...
        w.prototype.setTickPositions = function () {
          ...
          this.single =
            ...
            D(this.min) &&
            !this.tickAmount &&
            (parseInt(this.min, 10) === this.min || !1 !== d.allowDecimals);
          ...
          !b &&
            ...
            !(
              ...
              : ((b = [this.min, this.max]), v(19, !1, this.chart)),
            b.length > this.len &&
          ...
          this.isLinked ||
            (this.single &&
              2 > b.length &&
              !this.categories &&
              !this.series.some(function (d) {
                return (
                  d.is("heatmap") && "between" === d.options.pointPlacement
                );
              }) &&
        ...
        w.prototype.trimTicks = function (d, a, b) {
          ...
          if (!this.isLinked) {
            ...
            else for (; this.min - f > d[0]; ) d.shift();
            if (b) this.max = t;
            else for (; this.max + f < d[d.length - 1]; ) d.pop();
            0 === d.length &&
              D(c) &&
        ...
        w.prototype.setScale = function () {
          ...
          this.series.forEach(function (d) {
            ...
            b =
              b ||
              (null === (c = d.xAxis) || void 0 === c ? void 0 : c.isDirty) ||
              !1;
          });
          ...
          A(this, "zoom", d, function (d) {
            ...
            if (a !== b.min || f !== b.max)
              b.allowZoomOutside ||
                ...
                D(t) && (f < l && (f = l), f > e && (f = e))),
                (b.displayBtn =
                  "undefined" !== typeof a || "undefined" !== typeof f),
                b.setExtremes(a, f, !1, void 0, { trigger: "zoom" });
            d.zoomed = !0;
          });
          return d.zoomed;
        };
        w.prototype.setAxisSize = function () {
          var d = this.chart,
            ...
            f = (this.width = Math.round(
              C(E(a.width, d.plotWidth - b[3] + b[1]), d.plotWidth)
            )),
            l = (this.height = Math.round(
              C(E(a.height, d.plotHeight - b[0] + b[2]), d.plotHeight)
            )),
            e = (this.top = Math.round(
              C(E(a.top, d.plotTop + b[0]), d.plotHeight, d.plotTop)
            ));
          a = this.left = Math.round(
            C(E(a.left, d.plotLeft + b[3]), d.plotWidth, d.plotLeft)
          );
        ...
        w.prototype.tickSize = function (d) {
          var a = this.options,
            ...
            c = E(
              a["tick" === d ? "tickWidth" : "minorTickWidth"],
              "tick" === d && this.isXAxis && !this.categories ? 1 : 0
            );
          if (c && b) {
        ...
        w.prototype.unsquish = function () {
          ...
          a
            ? (C =
                ...
                (D(e)
                  ? [e]
                  : f < E(d.autoRotationLimit, 80) && d.autoRotation)) &&
        ...
        w.prototype.getSlotWidth = function (d) {
          ...
          if (c && l && 2 > (l.step || 0))
            return l.rotation ? 0 : ((this.staggerLines || 1) * this.len) / e;
          if (!c) {
            d =
              null === (a = null === l || void 0 === l ? void 0 : l.style) ||
              void 0 === a
                ? void 0
                : a.width;
        ...
        w.prototype.renderUnsquish = function () {
          ...
          c.forEach(function (d) {
            ...
            d &&
              d.label &&
              d.label.textPxLength > m &&
              (m = d.label.textPxLength);
          });
              ...
              for (p = c.length; !k && p--; ) {
                ...
                if ((r = f[r].label))
                  r.styles && "ellipsis" === r.styles.textOverflow
                    ...
                    : r.textPxLength > x && r.css({ width: x + "px" }),
                    r.getBBox().height > this.len / c.length - (E.h - E.f) &&
                      (r.specificTextOverflow = "ellipsis");
              }
            }
          }
          g.rotation &&
            ((w = m > 0.5 * d.chartHeight ? 0.33 * d.chartHeight : m),
            C || (u = "ellipsis"));
          if (
            (this.labelAlign =
              l.align || this.autoLabelAlign(this.labelRotation))
          )
          ...
          c.forEach(function (d) {
            ...
            a &&
              ...
              d.shortenLabel
                ...
                ? ((c.width = w + "px"),
                  C || (c.textOverflow = a.specificTextOverflow || u),
                  a.css(c))
                : a.styles &&
                  a.styles.width &&
                  !c.width &&
        ...
        w.prototype.addTitle = function (d) {
          ...
          this.axisTitle ||
            ...
            (this.axisTitle = a
              ...
              .attr({ zIndex: 7, rotation: f.rotation || 0, align: e })
              .addClass("highcharts-axis-title")),
            k || this.axisTitle.css(l(f.style)),
        ...
        w.prototype.getOffset = function () {
          ...
          d.axisGroup ||
            ((d.gridGroup = b
              ...
              .addClass(
                "highcharts-" + this.coll.toLowerCase() + "-grid " + (K || "")
              )
              .add(N)),
            (d.axisGroup = b
              .g("axis")
              ...
              .addClass(
                "highcharts-" + this.coll.toLowerCase() + " " + (K || "")
              )
              .add(N)),
            (d.labelGroup = b
              .g("axis-labels")
              ...
              .addClass(
                "highcharts-" + d.coll.toLowerCase() + "-labels " + (K || "")
              )
              .add(N)));
          I || d.isLinked
            ? (f.forEach(function (a, b) {
              ...
              d.staggerLines && (r *= d.staggerLines),
              (d.labelOffset = r * (d.opposite ? -1 : 1)))
            : x(l, function (a, d) {
                a.destroy();
                delete l[d];
              });
          if (
            ...
            w.text &&
            !1 !== w.enabled &&
            (d.addTitle(g), g && !1 !== w.reserveSpace)
          ) {
          ...
          d.getMaxLabelDimensions &&
            (d.maxLabelDimensions = d.getMaxLabelDimensions(l, f));
          e = this.tickSize("tick");
          v[k] = Math.max(
            v[k],
            d.axisTitleMargin + C + h * d.offset,
            m,
            f && f.length && e ? e[0] + h * d.offset : 0
          );
        ...
        w.prototype.getLinePath = function (a) {
          ...
          return d.renderer.crispLine(
            [
              ...
              [
                "L",
                f ? d.chartWidth - this.right : l,
                f ? c : d.chartHeight - this.bottom,
              ],
            ],
            a
          );
        ...
        w.prototype.getTitlePosition = function () {
          ...
          A(this, "afterGetTitlePosition", { titlePosition: a });
          return a;
        };
        ...
        w.prototype.renderTick = function (a, b) {
          ...
          if (
            ...
            (null === (d = this.grid) || void 0 === d ? 0 : d.isColumn)
          )
            l[a] || (l[a] = new z(this, a)),
              t && l[a].isNew && l[a].render(b, !0, -1),
              l[a].render(b);
        };
        w.prototype.render = function () {
          ...
          if (a.hasData() || e)
            a.minorTickInterval &&
              !a.categories &&
              a.getMinorTickPositions().forEach(function (d) {
                a.renderMinorTick(d);
              }),
              k.length &&
                ...
                u &&
                  (0 === a.min || a.single) &&
                  (g[-1] || (g[-1] = new z(a, -1, null, !0)),
                  g[-1].render(-1))),
              w &&
                k.forEach(function (d, f) {
                  N =
                    "undefined" !== typeof k[f + 1] ? k[f + 1] + u : a.max - u;
                  0 === f % 2 &&
                    d < a.max &&
                    N <= a.max + (b.polar ? -u : u) &&
                    (C[d] || (C[d] = new q.PlotLineOrBand(a)),
                    (K = d + u),
                    (C[d].options = {
          ...
          p &&
            v &&
            ((l = a.getTitlePosition()),
            f(l.y)
              ? (p[p.isNew ? "attr" : "animate"](l), (p.isNew = !1))
        ...
        w.prototype.destroy = function (a) {
          ...
          for (c in d.plotLinesAndBandsGroups)
            d.plotLinesAndBandsGroups[c] =
              d.plotLinesAndBandsGroups[c].destroy();
          x(d, function (a, b) {
            -1 === d.getKeepProps().indexOf(b) && delete d[b];
          });
        };
        w.prototype.drawCrosshair = function (a, b) {
          var d = this.crosshair,
            c = E(d.snap, !0),
            f,
            l = this.cross,
            t = this.chart;
          A(this, "drawCrosshair", { e: a, point: b });
          ...
          if (this.crosshair && !1 !== (D(b) || !c)) {
            ...
            l ||
              ...
              t.styledMode ||
                ...
                d.dashStyle && l.attr({ dashstyle: d.dashStyle })));
            l.show().attr({ d: e });
            c && !d.width && l.attr({ "stroke-width": this.transA });
            this.cross.e = a;
          } else this.hideCrosshair();
          A(this, "afterDrawCrosshair", { e: a, point: b });
        };
  ...
  O(
    ...
    [q["Core/Axis/Axis.js"], q["Core/Utilities.js"]],
    function (n, h) {
      var q = h.addEvent,
        z = h.getMagnitude,
        ...
        M = (function () {
          ...
          h.prototype.normalizeTimeTickInterval = function (h, r) {
            ...
            for (
              ...
              (g = F[r[0]]),
              (n = r[1]),
              m[H + 1] && h <= (g * n[n.length - 1] + F[m[H + 1][0]]) / 2);
              H++
            );
            g === F.year && h < 5 * g && (n = [1, 2, 5]);
            h = y(h / g, n, "year" === r[0] ? Math.max(z(h / g), 1) : 1);
            return { unitRange: g, count: h, unitName: r[0] };
          };
          return h;
        })();
      h = (function () {
      ...
      var q = h.addEvent,
        ...
        M = (function () {
          ...
          h.prototype.getLogTickPositions = function (h, r, m, g) {
            ...
            if (0.5 <= h)
              (h = Math.round(h)), (u = n.getLinearTickPositions(h, r, m));
            else if (0.08 <= h) {
              v = Math.floor(r);
              var A, p;
              for (
              ...
              (r = this.lin2log(r)),
                (m = this.lin2log(m)),
                (h = g ? n.getMinorTickInterval() : v.tickInterval),
                (h = F(
                  "auto" === h ? null : h,
                  this.minorAutoInterval,
                  ((v.tickPixelInterval / (g ? 5 : 1)) * (m - r)) /
                    ((g ? H / n.tickPositions.length : H) || 1)
                )),
                (h = y(h, void 0, z(h))),
                (u = n.getLinearTickPositions(h, r, m).map(this.log2lin)),
      ...
      h = (function () {
        ...
        h.compose = function (h) {
          ...
          q(h, "init", function (g) {
            ...
            "logarithmic" !== g.userOptions.type
              ? (this.logarithmic = void 0)
              : (m || (m = this.logarithmic = new M(this)),
                this.log2lin !== m.log2lin &&
                  (m.log2lin = this.log2lin.bind(this)),
                this.lin2log !== m.lin2log &&
                  (m.lin2log = this.lin2log.bind(this)));
          });
  ...
  O(
    ...
    [q["Core/Axis/Axis.js"], q["Core/Globals.js"], q["Core/Utilities.js"]],
    function (n, h, q) {
      var z = q.arrayMax,
        y = q.arrayMin,
        F = q.defined,
      ...
      q = (function () {
        ...
        n.prototype.render = function () {
          ...
          var N = {},
            I = v.chart.renderer,
            w = l ? "bands" : "lines";
          A && ((f = A.log2lin(f)), (e = A.log2lin(e)), (b = A.log2lin(b)));
          v.chart.styledMode ||
            (a
              ? ((C.stroke = K || "#999999"),
                (C["stroke-width"] = g(p.width, 1)),
                p.dashStyle && (C.dashstyle = p.dashStyle))
              : l &&
                ((C.fill = K || "#e6ebf5"),
                p.borderWidth &&
                  ((C.stroke = p.borderColor),
                  (C["stroke-width"] = p.borderWidth))));
          N.zIndex = q;
          w += "-" + q;
          (A = v.plotLinesAndBandsGroups[w]) ||
            (v.plotLinesAndBandsGroups[w] = A =
              I.g("plot-" + w)
                .attr(N)
                .add());
          ...
          else if (l) C = v.getPlotBandPath(f, e, p);
          else return;
          !n.eventsAdded &&
            D &&
            (m(D, function (a, b) {
          ...
          (E || !x.d) && C && C.length
            ...
            : x &&
              (C
                ? (x.show(!0), x.animate({ d: C }))
                : x.d && (x.hide(), c && (n.label = c = c.destroy())));
          k &&
          (F(k.text) || F(k.formatter)) &&
          C &&
          C.length &&
          0 < v.width &&
          0 < v.height &&
          !C.isFlat
            ? ((k = r(
              ...
              this.renderLabel(k, C, l, q))
            : c && c.hide();
          return n;
        };
        n.prototype.renderLabel = function (g, m, h, r) {
          var p = this.label,
          ...
          p ||
            ...
            (p.zIndex = r),
            (r = this.getLabelText(g)),
            (this.label = p = k.text(r, 0, 0, g.useHTML).attr(p).add()),
            this.axis.chart.styledMode || p.css(g.style));
          k = m.xBounds || [m[0][1], m[1][1], h ? m[2][1] : m[0][1]];
          m = m.yBounds || [m[0][2], m[1][2], h ? m[2][2] : m[0][2]];
          h = y(k);
          r = y(m);
          p.align(g, !1, { x: h, y: r, width: z(k) - h, height: z(m) - r });
          p.show(!0);
        };
        n.prototype.getLabelText = function (g) {
      ...
      B(n.prototype, {
        ...
        addPlotBandOrLine: function (g, m) {
          var r = new h.PlotLineOrBand(this, g),
            u = this.userOptions;
    ...
    function (n, h) {
      ...
      var p = (function () {
        ...
        k.prototype.destroy = function () {
          ...
          this.renderer &&
            ((this.renderer = this.renderer.destroy()), M(this.container));
        ...
        k.prototype.getAnchor = function (c, e) {
          ...
          this.followPointer && e
            ...
            : (c.forEach(function (b) {
                ...
                p +=
                  (b.plotLow ? (b.plotLow + b.plotHigh) / 2 : b.plotY) +
                  (!l && m ? m.top - a : 0);
              }),
              (g /= c.length),
              (p /= c.length),
        ...
        k.prototype.getDateFormat = function (c, e, f, b) {
          ...
          for (p in A) {
            ...
            if (k[p] && a.substr(k[p]) !== "01-01 00:00:00.000".substr(k[p]))
              break;
            "week" !== p && (g = p);
          }
        ...
        k.prototype.getLabel = function () {
          ...
          if (!this.label) {
            this.outside &&
              ((this.container = g = n.doc.createElement("div")),
        ...
        k.prototype.getPosition = function (c, e, f) {
          var b = this.chart,
            ...
            d = function (a) {
              var d = "x" === a;
              return [a, d ? m : h, d ? c : e].concat(
                p
                  ? [
                      d ? v(c) : w(e),
                      d
                        ? r.left - l + v(f.plotX + b.plotLeft)
                        : r.top - l + w(f.plotY + b.plotTop),
                      0,
                      d ? m : h,
                    ]
                  : [
                      d ? c : e,
                      d ? f.plotX + b.plotLeft : f.plotY + b.plotTop,
            ...
            J = d("x"),
            n =
              !this.followPointer && H(f.ttBelow, !b.inverted === !!f.negative),
        ...
        k.prototype.getXDateFormat = function (c, e, f) {
          ...
          return (
            (b
              ? this.getDateFormat(b, c.x, f.options.startOfWeek, e)
              : e.day) || e.year
          );
        };
        ...
        k.prototype.move = function (c, e, f, b) {
          var l = this,
            a = l.now,
            k =
              !1 !== l.options.animation &&
              !l.isHidden &&
              (1 < Math.abs(c - a.x) || 1 < Math.abs(e - a.y)),
            g = l.followPointer || 1 < l.len;
          G(a, {
            x: k ? (2 * a.x + c) / 3 : c,
            y: k ? (a.y + e) / 2 : e,
            anchorX: g ? void 0 : k ? (2 * a.anchorX + f) / 3 : f,
        ...
        k.prototype.refresh = function (c, e) {
          ...
          if (b.enabled) {
            ...
            e = m[0];
            var r = m[1];
            !a || (l.series && l.series.noSharedTooltip)
              ? (a = l.getLabelConfig())
              : (f.pointer.applyInactiveState(l),
                l.forEach(function (a) {
                  a.setState("hover");
                  k.push(a.getLabelConfig());
                }),
                (a = { x: l[0].category, y: l[0].y }),
                (a.points = k),
                (l = l[0]));
            this.len = k.length;
            f = g.call(a, this);
              ...
              : (this.split
                  ...
                  : ((c = this.getLabel()),
                    ...
                    c
                      ...
                      .addClass(
                        "highcharts-color-" + H(l.colorIndex, g.colorIndex)
                      ),
                    p ||
                      c.attr({
                        stroke:
                          b.borderColor || l.color || g.color || "#666666",
                      }),
                    this.updatePosition({
                      plotX: e,
                      plotY: r,
        ...
        k.prototype.renderSplit = function (c, e) {
          function f(a, d, b, c, f) {
            void 0 === f && (f = !0);
            b
              ? ((d = B ? 0 : L), (a = z(a - c / 2, A.left, A.right - c)))
              : ((d -= y),
                (a = f ? a - c - t : a + t),
                (a = z(a, f ? a : A.left, A.right)));
            return { x: a, y: d };
          }
          var b = this,
            l = b.chart,
          ...
          c = c.slice(0, e.length + 1).reduce(function (a, c, l) {
            if (!1 !== c && "" !== c) {
              ...
              var C = l.series;
              var u =
                "highcharts-color-" + H(l.colorIndex, C.colorIndex, "none");
              h ||
                ((h = { padding: J.padding, r: J.borderRadius }),
                d ||
                  ((h.fill = J.backgroundColor),
                  (h["stroke-width"] = J.borderWidth)),
                (h = r
                  .label(
                    "",
                    0,
                    0,
                    J[E ? "headerShape" : "shape"] || "callout",
                    void 0,
                    void 0,
                    J.useHTML
                  )
              ...
              d ||
                h
                  ...
                  .shadow(J.shadow)
                  .attr({
                    stroke: J.borderColor || l.color || C.color || "#333333",
                  });
              c = x.tt = h;
              E = c.getBBox();
          ...
          b.outside &&
            ...
            l &&
            ((a = D.getBBox()),
            l.setSize(a.width + a.x, a.height + a.y, !1),
            (h = h.getChartPosition()),
            (c.style.left = h.left + "px"),
            (c.style.top = h.top + "px"));
        };
        k.prototype.drawTracker = function () {
          if (this.followPointer || !this.options.stickOnContact)
            ...
            if (e && f) {
              ...
              b.width =
                0 > f[0]
                  ? Math.max(Math.abs(f[0]), l.width - f[0])
                  : Math.max(Math.abs(f[0]), l.width);
              b.height =
                0 > f[1]
                  ? Math.max(Math.abs(f[1]), l.height - Math.abs(f[1]))
                  : Math.max(Math.abs(f[1]), l.height);
              this.tracker
                ? this.tracker.attr(b)
        ...
        k.prototype.tooltipFooterHeaderFormatter = function (c, e) {
          ...
          B(this, "headerFormatter", e, function (f) {
            ...
            f.text = r(p, { point: c, series: b }, this.chart);
          });
          return e.text;
        };
    ...
    function (n, h, q, z) {
      ...
      n = (function () {
          ...
          if (!v || !v.touch)
            if (
              ...
              v &&
                k &&
                ((a -= w),
                v.attr({ width: Math.abs(a), x: (0 < a ? 0 : a) + w }));
              v &&
                g &&
                ((a = e - d),
                v.attr({ height: Math.abs(a), y: (0 < a ? 0 : a) + d }));
        ...
        e.prototype.drop = function (c) {
            ...
            if (this.hasDragged || a)
              f.axes.forEach(function (f) {
                if (
                  f.zoomEnabled &&
                  m(f.min) &&
                  (a || b[{ xAxis: "zoomX", yAxis: "zoomY" }[f.coll]]) &&
                  v(p) &&
                  v(h)
                ) {
                  var l = f.horiz,
                ...
                N &&
                  H(f, "selection", e, function (b) {
                    f.zoom(g(b, a ? { animation: !1 } : null));
                  });
            v(f.index) &&
          ...
          f &&
            v(f.index) &&
            (r(f.container, { cursor: f._cursor }),
        ...
        e.prototype.findNearestKDPoint = function (c, b, l) {
          var a = this.chart,
            f = a.hoverPoint;
          a = a.tooltip;
          if (f && a && a.isStickyOnContact()) return f;
          var e;
          c.forEach(function (a) {
            var c =
              !(a.noSharedTooltip && b) &&
        ...
        e.prototype.getChartCoordinatesFromPoint = function (c, b) {
          var f = c.series,
            a = f.xAxis;
          f = f.yAxis;
          var e = k(c.clientX, c.plotX),
            g = c.shapeArgs;
          if (a && f)
            return b
              ? { chartX: a.len + a.pos - e, chartY: f.len + f.pos - c.plotY }
              : { chartX: e + a.pos, chartY: c.plotY + f.pos };
        ...
        e.prototype.getHoverData = function (c, b, l, a, e, g) {
          var f,
            p = [];
          a = !(!a || !c);
          ...
          x = x
            ...
            : l.filter(function (a) {
                return m.filter
                  ...
                  : a.visible &&
                      !(!e && a.directTouch) &&
                      k(a.options.enableMouseTracking, !0) &&
                      a.stickyTracking;
              });
          b = (f = a || !g ? c : this.findNearestKDPoint(x, e, g)) && f.series;
          f &&
            (e && !b.noSharedTooltip
              ? ((x = l.filter(function (a) {
                  return m.filter
                    ? m.filter(a)
                    : a.visible &&
                        !(!e && a.directTouch) &&
                ...
                x.forEach(function (a) {
                  ...
                  u(b) &&
                    (a.chart.isBoosting && (b = a.getPoint(b)), p.push(b));
                }))
              : p.push(f));
          m = { hoverPoint: f };
          H(this, "afterGetHoverData", m);
          return { hoverPoint: m.hoverPoint, hoverSeries: b, hoverPoints: p };
        };
        ...
        e.prototype.init = function (c, b) {
          ...
          this.lastValidTouch = {};
          q &&
            ((c.tooltip = new q(c, b.tooltip)),
            (this.followTouchMove = k(b.tooltip.followTouchMove, !0)));
          this.setDOMEvents();
        };
        e.prototype.normalize = function (c, b) {
          var f = c.touches,
            a = f
              ? f.length
                ? f.item(0)
                : k(f.changedTouches, c.changedTouches)[0]
              : c;
          b || (b = this.getChartPosition());
          f = a.pageX - b.left;
          b = a.pageY - b.top;
          if ((a = this.chart.containerScaling))
            (f /= a.scaleX), (b /= a.scaleY);
          return g(c, { chartX: Math.round(f), chartY: Math.round(b) });
        };
        e.prototype.onContainerClick = function (c) {
          ...
          b.cancelClick ||
            (f && this.inClass(c.target, "highcharts-tracker")
              ? (H(f.series, "click", g(c, { point: f })),
                b.hoverPoint && f.firePointEvent("click", c))
              : (g(c, this.getCoordinates(c)),
                b.isInsidePlot(c.chartX - a, c.chartY - e) &&
                  H(b, "click", c)));
        };
        e.prototype.onContainerMouseDown = function (c) {
          ...
          if ("undefined" === typeof c.button || b)
            this.zoomOption(c),
              b && c.preventDefault && c.preventDefault(),
              this.dragStart(c);
        };
        ...
        e.prototype.pinch = function (c) {
          var b = this,
            ...
            n = {};
          1 < p && (b.initiated = !0);
          h && b.initiated && !v && !1 !== c.cancelable && c.preventDefault();
          [].map.call(e, function (a) {
            return b.normalize(a);
          });
          "touchstart" === c.type
            ? ([].forEach.call(e, function (b, d) {
                a[d] = { chartX: b.chartX, chartY: b.chartY };
              }),
              (m.x = [a[0].chartX, a[1] && a[1].chartX]),
              (m.y = [a[0].chartY, a[1] && a[1].chartY]),
              ...
              (b.res = !0))
            : b.followTouchMove && 1 === p
            ? this.runPointActions(b.normalize(c))
            : a.length &&
              (r ||
                (b.selectionMarker = r =
                  g({ destroy: L, touch: !0 }, f.plotBox)),
              b.pinchTranslate(a, e, u, r, n, m),
              (b.hasPinched = h),
              b.scaleGroups(u, n),
        ...
        e.prototype.runPointActions = function (c, b) {
          ...
          if (g && (g !== f.hoverPoint || (a && a.isHidden))) {
            ...
            b &&
              ...
              !a.isHidden &&
              ((g = a.getAnchor([{}], c)),
              a.updatePosition({ plotX: g[0], plotY: g[1] }));
          this.unDocMouseMove ||
            (this.unDocMouseMove = G(
          ...
          f.axes.forEach(function (a) {
            var b = k((a.crosshair || {}).snap, !0),
              e;
            b &&
              (((e = f.hoverPoint) && e.series[a.coll] === a) ||
                (e = D(m, function (b) {
        ...
        e.prototype.scaleGroups = function (c, b) {
          ...
          f.series.forEach(function (e) {
            ...
            e.xAxis &&
              ...
              (e.group.attr(a),
              e.markerGroup &&
                (e.markerGroup.attr(a),
                e.markerGroup.clip(b ? f.clipRect : null)),
              e.dataLabelsGroup && e.dataLabelsGroup.attr(a));
          });
        ...
        e.prototype.setDOMEvents = function () {
          ...
          this.unbindContainerMouseEnter = G(
            c,
            "mouseenter",
            this.onContainerMouseEnter.bind(this)
          );
          this.unbindContainerMouseLeave = G(
            c,
            "mouseleave",
            this.onContainerMouseLeave.bind(this)
          );
          h.unbindDocumentMouseUp ||
            (h.unbindDocumentMouseUp = G(
              b,
              "mouseup",
              this.onDocumentMouseUp.bind(this)
            ));
          h.hasTouch &&
            (G(c, "touchstart", this.onContainerTouchStart.bind(this)),
            G(c, "touchmove", this.onContainerTouchMove.bind(this)),
            h.unbindDocumentTouchEnd ||
              (h.unbindDocumentTouchEnd = G(
                b,
                "touchend",
        ...
        e.prototype.setHoverChartIndex = function () {
          ...
          if (b && b !== c)
            b.pointer.onContainerMouseLeave({ relatedTarget: !0 });
            ...
            if (
              ...
              if ("touchmove" === c.type) {
                ...
                var f = b[0]
                  ? 4 <=
                    Math.sqrt(
                      Math.pow(b[0].chartX - c.chartX, 2) +
                        Math.pow(b[0].chartY - c.chartY, 2)
                    )
                  : !1;
              }
              k(f, !0) && this.pinch(c);
  ...
  O(
    q,
    "Core/MSPointer.js",
    [q["Core/Globals.js"], q["Core/Pointer.js"], q["Core/Utilities.js"]],
    function (n, h, q) {
      function z() {
        var m = [];
        m.item = function (g) {
        ...
        g(H, function (g) {
          m.push({ pageX: g.pageX, pageY: g.pageY, target: g.target });
        });
        return m;
      }
      function y(g, m, p, k) {
        ("touch" !== g.pointerType &&
          g.pointerType !== g.MSPOINTER_TYPE_TOUCH) ||
          !L[n.hoverChartIndex] ||
          (k(g),
      ...
      return (function (g) {
        ...
        h.prototype.init = function (p, k) {
          g.prototype.init.call(this, p, k);
          this.hasZoom &&
            m(p.container, {
        ...
        e = (function () {
          ...
          c.prototype.setOptions = function (b) {
            ...
            this.chart.styledMode ||
              ...
              (this.itemHiddenStyle = H(this.itemStyle, b.itemHiddenStyle)));
          ...
          c.prototype.colorizeItem = function (b, c) {
            ...
            if (!this.chart.styledMode) {
              ...
              var g = c ? b.color || k : k,
                ...
                h = { fill: g };
              e && e.css({ fill: a, color: a });
              f && f.attr({ stroke: g });
              l &&
                (p &&
                  l.isMarker &&
                  ((h = b.pointAttribs()), c || (h.stroke = h.fill = k)),
                l.attr(h));
            }
            m(this, "afterColorizeItem", { item: b, visible: c });
          };
          ...
          c.prototype.renderItem = function (b) {
            ...
            r ||
              ((b.legendGroup = a
                ...
                .addClass(
                  "highcharts-" +
                    ...
                    b.colorIndex +
                    (n ? " " + n : "") +
                    (u ? " highcharts-series-" + b.index : "")
                )
                .attr({ zIndex: 1 })
                .add(this.scrollGroup)),
              (b.legendItem = r =
                a.text("", h ? f + k : -k, this.baseline || 0, J)),
              c.styledMode || r.css(H(b.visible ? g : p)),
              r
                .attr({ align: h ? "left" : "right", zIndex: 2 })
                .add(b.legendGroup),
              this.baseline ||
              ...
              d.drawLegendSymbol(this, b),
              this.setItemEvents && this.setItemEvents(b, r, J));
            t &&
              !b.checkbox &&
            ...
            b.itemWidth = b.checkboxOffset =
              e.itemWidth || b.legendItemWidth || c.width + m;
            ...
            this.itemHeight = b.itemHeight = Math.round(
              b.legendItemHeight || c.height || this.symbolHeight
            );
          };
          c.prototype.layoutItem = function (b) {
            ...
            e &&
              ...
              ((this.itemX = a),
              this.lastLineHeight &&
                (this.itemY += g + this.lastLineHeight + k),
            ...
            e
              ? (this.itemX += c)
              : ((this.itemY += g + f + k), (this.lastLineHeight = f));
            this.offsetWidth =
              this.widthOption ||
              Math.max(
                (e ? this.itemX - a - (b.checkbox ? 0 : p) : c) + a,
                this.offsetWidth
              );
          };
          c.prototype.getAllItems = function () {
            ...
            this.chart.series.forEach(function (c) {
              var a = c && c.options;
              c &&
                v(a.showInLegend, G(a.linkedTo) ? !1 : void 0, !0) &&
                (b = b.concat(
                  c.legendItems || ("point" === a.legendType ? c.data : c)
                ));
            });
            m(this, "afterGetAllItems", { allItems: b });
            return b;
          };
          ...
          c.prototype.adjustMargins = function (b, c) {
            var a = this.chart,
              e = this.options,
              f = this.getAlignment();
            f &&
              [
                ...
                l.test(f) &&
                  ...
                  (a[k[g]] = Math.max(
                    a[k[g]],
                    a.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] +
                      [1, -1, -1, 1][g] * e[g % 2 ? "x" : "y"] +
                      v(e.margin, 12) +
                      c[g] +
                      (a.titleOffset[g] || 0)
          ...
          c.prototype.proximatePositions = function () {
            ...
            this.allItems.forEach(function (e) {
              ...
              var l = a;
              if (e.yAxis) {
                e.xAxis.options.reversed && (l = !l);
                e.points &&
                  (f = r(
                    l ? e.points : e.points.slice(0).reverse(),
                    function (a) {
                      return D(a.plotY);
                    }
                  ));
                ...
                e.visible
                  ? ((f = f ? f.plotY : e.yAxis.height), (f += k - 0.3 * l))
                  : (f = k + e.yAxis.height);
                c.push({ target: f, size: l, item: e });
              }
            }, this);
          ...
          c.prototype.render = function () {
            ...
            var g = b.spacingBox.width - 2 * k - f.x;
            -1 < ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) &&
              (g /= 2);
            this.maxLegendWidth = this.widthOption || g;
            a ||
              ((this.group = a = c.g("legend").attr({ zIndex: 7 }).add()),
              (this.contentGroup = c.g().attr({ zIndex: 1 }).add(a)),
          ...
          c.prototype.handleOverflow = function (b) {
            var c = this,
              ...
              k = f.y,
              g = this.padding;
            k = a.spacingBox.height + ("top" === f.verticalAlign ? -k : k) - g;
            var p = f.maxHeight,
              m,
              h = this.clipRect,
              r = f.navigation,
            ...
            b > k && !1 !== r.enabled
              ? ((this.clipHeight = m =
                  Math.max(k - 20 - this.titleHeight - g, 0)),
                ...
                h ||
                  ((h = c.clipRect = e.clipRect(0, g, 9999, 0)),
                  c.contentGroup.clip(h)),
                A(m),
                t ||
                  ((this.nav = t = e.g().attr({ zIndex: 1 }).add(this.group)),
                  (this.up = e.symbol("triangle", 0, 0, d, d).add(t)),
                  H("upTracker").on("click", function () {
                    c.scroll(-1, u);
                  }),
                  (this.pager = e
                    .text("", 15, 10)
                    .addClass("highcharts-legend-navigation")),
                  a.styledMode || this.pager.css(r.style),
                  this.pager.add(t),
                  (this.down = e.symbol("triangle-down", 0, 0, d, d).add(t)),
                  H("downTracker").on("click", function () {
                    c.scroll(1, u);
                  })),
                c.scroll(0),
                (b = k))
          ...
          c.prototype.scroll = function (b, c) {
            ...
            0 < k &&
              ...
              e.styledMode ||
                ...
                this.upTracker.css({ cursor: 1 === k ? "default" : "pointer" }),
                this.down.attr({
              ...
              (c = z(v(c, e.renderer.globalAnimation, !0))),
              p(function () {
                m(a, "afterScroll", { currentPage: k });
              }, c.duration));
          };
          return c;
        })();
      (/Trident\/7\.0/.test(c.navigator && c.navigator.userAgent) || q) &&
        n(e.prototype, "positionItem", function (c, b) {
          var e = this,
            a = function () {
    ...
    function (n, h, q) {
      ...
      n = (function () {
        ...
        p.prototype.animateBeforeDestroy = function () {
          var k = this,
            c = { x: k.startXPos, opacity: 0 },
            e,
            f = k.getGraphicalProps();
          f.singular.forEach(function (b) {
            e = "dataLabel" === b;
            k[b] = k[b].animate(
              e ? { x: k[b].startXPos, y: k[b].startYPos, opacity: 0 } : c
            );
          });
        ...
        p.prototype.applyOptions = function (k, c) {
          ...
          L(this, k);
          this.options = this.options ? L(this.options, k) : k;
        ...
        p.prototype.destroy = function () {
          ...
          e && e.enabled
            ? (this.animateBeforeDestroy(), H(k, l.duration))
            : k();
          f.pointCount--;
        };
        ...
        p.prototype.firePointEvent = function (k, c, e) {
          ...
          (b.point.events[k] ||
            (f.options && f.options.events && f.options.events[k])) &&
            f.importEvents();
          "click" === k &&
            b.allowPointSelect &&
            (e = function (b) {
        ...
        p.prototype.getGraphicalProps = function (k) {
          ...
          k.dataLabel && e.push("dataLabel", "dataLabelUpper", "connector");
          for (f = e.length; f--; ) {
            var l = e[f];
        ...
        p.prototype.getNestedProperty = function (k) {
          if (k)
            return 0 === k.indexOf("custom.") ? r(k, this.options) : this[k];
        };
        ...
        p.prototype.optionsToObject = function (k) {
          ...
          if (g(k) || null === k) c[b[0]] = k;
            ...
            for (
              ...
              k.length > l &&
              ((e = typeof k[0]),
              "string" === e ? (c.name = k[0]) : "number" === e && (c.x = k[0]),
              a++);
              h < l;

            )
              (f && "undefined" === typeof k[a]) ||
                (0 < b[h].indexOf(".")
                  ? p.prototype.setNestedProperty(c, k[a], b[h])
                  : (c[b[h]] = k[a])),
                a++,
                h++;
          else
            "object" === typeof k &&
              ((c = k),
              k.dataLabels && (e._hasPointLabels = !0),
              k.marker && (e._hasPointMarkers = !0));
          return c;
        };
        p.prototype.resolveColor = function () {
          ...
          k.options.colorByPoint
            ? (e ||
                ((c = k.options.colors || k.chart.options.colors),
                (this.color = this.color || c[k.colorCounter]),
                (c = c.length)),
              (e = k.colorCounter),
              k.colorCounter++,
              k.colorCounter === c && (k.colorCounter = 0))
            : (e = k.colorIndex);
          this.colorIndex = v(this.colorIndex, e);
        };
  ...
  O(
    ...
    [q["Core/Globals.js"], q["Core/Series/Point.js"], q["Core/Utilities.js"]],
    function (n, h, q) {
      var z = q.error,
        y = q.extendClass,
        F = q.fireEvent,
      ...
      q = (function () {
        ...
        m.cleanRecursively = function (g, h) {
          var n = {};
          r(g, function (r, u) {
            if (G(g[u], !0) && !g.nodeType && h[u])
              (r = m.cleanRecursively(g[u], h[u])),
                Object.keys(r).length && (n[u] = r);
        ...
        m.seriesType = function (g, r, n, v, u) {
          ...
          r = r || "";
          q[g] = B(q[r], n);
          m.addSeries(g, y(p[r] || function () {}, v));
        ...
        m.prototype.update = function (g, h) {
          ...
          "undefined" !== typeof v &&
            v !== r.type &&
            (r = m.getSeries(r.chart, g));
          F(r, "update", { newOptions: g });
          r.userOptions = B(g);
          F(r, "afterUpdate", { newOptions: g });
          h && r.chart.redraw();
          return r;
        };
        m.defaultOptions = { type: "base" };
        m.seriesTypes = {};
        return m;
      })();
        ...
        U = (function () {
          ...
          n.prototype.init = function (a, b) {
            ...
            C(this, "init", { args: arguments }, function () {
              ...
              this.series = [];
              this.time =
                a.time && Object.keys(a.time).length ? new B(a.time) : z.time;
              this.numberFormatter = l.numberFormatter || t;
          ...
          n.prototype.initSeries = function (d) {
            ...
            c || a(17, !0, this, { missingModuleFor: b });
            b = new c(this, d);
          ...
          n.prototype.getSeriesOrderByLinks = function () {
            return this.series.concat().sort(function (a, d) {
              return a.linkedSeries.length || d.linkedSeries.length
                ? d.linkedSeries.length - a.linkedSeries.length
                : 0;
            });
          };
          ...
          n.prototype.isInsidePlot = function (a, d, b) {
            var c = b ? d : a;
            a = b ? a : d;
            c = {
              x: c,
              y: a,
              isInsidePlot:
                0 <= c && c <= this.plotWidth && 0 <= a && a <= this.plotHeight,
            };
          ...
          n.prototype.redraw = function (a) {
            ...
            if (w)
              for (a = c.length; a--; )
                (r = c[a]), r.options.stacking && (r.isDirty = !0);
            c.forEach(function (a) {
              a.isDirty &&
                ("point" === a.options.legendType
                  ? ("function" === typeof a.updateTotals && a.updateTotals(),
                    (l = !0))
                  : t && (t.labelFormatter || t.labelFormat) && (l = !0));
          ...
          n.prototype.getSelectedPoints = function () {
            ...
            this.series.forEach(function (d) {
              a = a.concat(
                d.getPointsCollection().filter(function (a) {
          ...
          n.prototype.layOutTitles = function (a) {
            ...
            var e =
              !this.titleOffset || this.titleOffset.join(",") !== d.join(",");
            this.titleOffset = d;
          ...
          n.prototype.temporaryDisplay = function (a) {
            ...
            if (a)
              for (; d && d.style; )
                d.hcOrigStyle && (e(d, d.hcOrigStyle), delete d.hcOrigStyle),
                  d.hcOrigDetached &&
                    (v.body.removeChild(d), (d.hcOrigDetached = !1)),
                  (d = d.parentNode);
            else
              for (; d && d.style; ) {
                v.body.contains(d) ||
                  d.parentNode ||
                  ((d.hcOrigDetached = !0), v.body.appendChild(d));
                if ("none" === K(d, "display", !1) || d.hcOricDetached)
                  (d.hcOrigStyle = {
          ...
          n.prototype.getContainer = function () {
            ...
            this.container = f = c("div", { id: t }, l, f);
          ...
          n.prototype.getMargins = function (a) {
            ...
            c[0] &&
              !f(b[0]) &&
              (this.plotTop = Math.max(this.plotTop, c[0] + d[0]));
            c[2] &&
              !f(b[2]) &&
              (this.marginBottom = Math.max(this.marginBottom, c[2] + d[2]));
            this.legend &&
              this.legend.display &&
          ...
          n.prototype.reflow = function (a) {
            ...
            if (!e && !d.isPrinting && t && b && (c === u || c === v)) {
              if (t !== d.containerWidth || b !== d.containerHeight)
                r.clearTimeout(d.reflowTimeout),
                  (d.reflowTimeout = X(
                    function () {
          ...
          n.prototype.setReflow = function (a) {
            ...
            !1 === a || this.unbindReflow
              ...
              : ((this.unbindReflow = p(u, "resize", function (a) {
          ...
          n.prototype.setChartSize = function (a) {
            ...
            this.plotHeight = m = Math.max(
              0,
              Math.round(e - g - this.marginBottom)
            );
            ...
            this.plotBox = b.plotBox = { x: k, y: g, width: p, height: m };
            ...
            this.clipBox = {
              ...
              height: Math.max(
                0,
                Math.floor(this.plotSizeY - Math.max(c, l[2]) / 2 - b)
              ),
            };
            a ||
          ...
          n.prototype.drawChartBox = function () {
            ...
            if (l) var q = (h = e.strokeWidth());
              ...
              g = { fill: g || "none" };
              if (q || e["stroke-width"])
                (g.stroke = a.borderColor), (g["stroke-width"] = q);
            ...
            f[J](n);
            l ||
              (f.attr({ fill: p || "none" }).shadow(a.plotShadow),
              m &&
                (k
                  ? (m !== k.attr("href") && k.attr("href", m), k.animate(n))
                  : (this.plotBGImage = d.image(m, r, x, u, w).add())));
            v
              ? v.animate({ width: E.width, height: E.height })
            ...
            t[J](
              t.crisp({ x: r, y: x, width: u, height: w }, -t.strokeWidth())
            );
            this.isDirtyBox = !1;
          ...
          n.prototype.propFromSeries = function () {
            ...
            ["inverted", "angular", "polar"].forEach(function (t) {
              ...
              for (e = c && c.length; !f && e--; )
                (b = q.seriesTypes[c[e].type]) && b.prototype[t] && (f = !0);
              a[t] = f;
            });
          };
          n.prototype.linkSeries = function () {
            ...
            d.forEach(function (d) {
              ...
              w(b) &&
                ...
                (d.linkedParent = b),
                b.enabledDataSorting && d.setDataSortingOptions(),
                (d.visible = P(
                  d.options.visible,
                  b.options.visible,
                  d.visible
          ...
          n.prototype.renderLabels = function () {
            ...
            d.items &&
              d.items.forEach(function (b) {
                ...
                delete c.left;
                delete c.top;
                a.renderer.text(b.html, e, f).attr({ zIndex: 2 }).css(c).add();
              });
          };
          n.prototype.render = function () {
            var a = this.axes,
            ...
            var t = (this.plotHeight = Math.max(this.plotHeight - e, 0));
            a.forEach(function (a) {
              a.setScale();
            });
            this.getAxisMargins();
          ...
          n.prototype.firstRender = function () {
            ...
            if (!a.isReadyToRender || a.isReadyToRender()) {
              ...
              G &&
                (a.pointer =
                  z.hasTouch || (!u.PointerEvent && !u.MSPointerEvent)
                    ? new G(a, d)
                    : new F(a, d));
              a.render();
        ...
        if (!this.renderer.forExport) {
          if (m) {
            if (
              ...
              this.plotWidth += m;
              this.inverted
                ? ((this.clipBox.height += m), (this.plotBox.height += m))
                : ((this.clipBox.width += m), (this.plotBox.width += m));
              var g = { 1: { name: "right", value: m } };
            }
          } else
            r &&
              (this.scrollablePixelsY = m =
                Math.max(0, r - this.chartHeight)) &&
              ((this.plotHeight += m),
              this.inverted
                ? ((this.clipBox.width += m), (this.plotBox.width += m))
                : ((this.clipBox.height += m), (this.plotBox.height += m)),
              (g = { 2: { name: "bottom", value: m } }));
          g &&
            !h.skipAxes &&
            this.axes.forEach(function (m) {
              g[m.side]
                ? (m.getPlotLinePath = function () {
                    var h = g[m.side].name,
                      r = this[h];
                    this[h] = r - g[m.side].value;
                    var u = q.Axis.prototype.getPlotLinePath.apply(
                      this,
                      arguments
                    );
                    this[h] = r;
      ...
      h.prototype.applyFixed = function () {
        ...
        m
          ? ((this.fixedDiv = L(
            ...
            null === (h = this.scrollingContainer) || void 0 === h
              ? void 0
            ...
            (this.fixedRenderer = h =
              new q.Renderer(
                ...
                this.chartWidth,
                this.chartHeight,
                null === (r = this.options.chart) || void 0 === r
                  ? void 0
                  : r.style
              )),
        ...
        this.chartBackground.attr({ width: r, height: h });
  ...
  O(
    ...
    [q["Core/Animation/AnimationUtilities.js"], q["Core/Utilities.js"]],
    function (n, h) {
        ...
        B = (function () {
          ...
          h.prototype.resetStacks = function () {
            ...
            h.axis.isXAxis ||
              M(g, function (g) {
                M(g, function (m, r) {
                  m.touched < h.stacksTouched
                    ? (m.destroy(), delete g[r])
    ...
    function (n, h) {
      ...
      return (n.LegendSymbolMixin = {
        drawRectangle: function (h, n) {
          ...
          n.legendSymbol = this.chart.renderer
            .rect(
              y ? (h.symbolWidth - q) / 2 : 0,
              h.baseline - q + 1,
              y ? q : h.symbolWidth,
              q,
              z(h.options.symbolRadius, q / 2)
            )
        ...
        drawLineMarker: function (h) {
          ...
          y &&
            !1 !== y.enabled &&
            G &&
            ((n = Math.min(z(y.radius, r), r)),
            0 === this.symbol.indexOf("url") &&
              ((y = q(y, { width: B, height: B })), (n = 0)),
            (this.legendSymbol = y =
              m
                .symbol(this.symbol, G / 2 - n, h - n, 2 * n, 2 * n, y)
                .addClass("highcharts-point")
                .add(g)),
            (y.isMarker = !0));
        },
  ...
  O(
    ...
    [
      ...
      q["Core/Series/Series.js"],
      q["Core/Globals.js"],
      q["Mixins/LegendSymbol.js"],
      q["Core/Options.js"],
      q["Core/Series/Point.js"],
      q["Core/Renderer/SVG/SVGElement.js"],
      q["Core/Utilities.js"],
    ],
        ...
        },
        {
          ...
          init: function (a, b) {
            ...
            C(t, function (a, b) {
              l(a) &&
                d.eventOptions[b] !== a &&
                (l(d.eventOptions[b]) && T(d, b, d.eventOptions[b]),
                (d.eventOptions[b] = a),
                m(d, b, a));
            });
            if (
            ...
            e(this, "bindAxes", null, function () {
              (a.axisTypes || []).forEach(function (d) {
                c[d].forEach(function (c) {
                  ...
                  if (
                    b[d] === f.index ||
                    ("undefined" !== typeof b[d] && b[d] === f.id) ||
                    ("undefined" === typeof b[d] && 0 === f.index)
                  )
          ...
          autoIncrement: function () {
            ...
            e &&
              ...
              "day" === e
                ...
                : "year" === e &&
                  f.set("FullYear", a, f.get("FullYear", a) + c),
              (c = a.getTime() - b));
            this.xIncrement = b + c;
            return b;
          },
          ...
          setOptions: function (a) {
            ...
            a = E(a);
            d = d.styledMode;
            var l = { plotOptions: c, userOptions: a };
            e(this, "setOptions", l);
          ...
          getCyclic: function (a, b, c) {
            var d = this.chart,
              ...
              l = c
                ? c.length
                : K(d.options.chart[a + "Count"], d[a + "Count"]);
            if (!b) {
              var k = K(e[f], e["_" + f]);
              u(k) ||
                (d.series.length || (d[t] = 0),
                (e["_" + f] = k = d[t] % l),
                (d[t] += 1));
              c && (b = c[k]);
            }
          ...
          findPointIndex: function (d, b) {
            ...
            "undefined" === typeof p && a(f) && (p = this.xData.indexOf(f, b));
            -1 !== p &&
              "undefined" !== typeof p &&
              this.cropped &&
          ...
          updateData: function (d, b) {
            ...
            d.forEach(function (d, b) {
              ...
              if (k.id || a(g)) {
                if (
                  ((g = this.findPointIndex(k, p)),
                  -1 === g || "undefined" === typeof g
                    ? t.push(d)
                    : f[g] && d !== c.data[g]
                    ? (f[g].update(d, !1, null, !1),
                      (f[g].touched = !0),
                      h && (p = g + 1))
                    : f[g] && (f[g].touched = !0),
                  !m || b !== g || (e && e.enabled) || this.hasDerivedData)
                )
                  l = !0;
              } else t.push(d);
            }, this);
            if (l)
              for (d = f.length; d--; )
                (k = f[d]) && !k.touched && k.remove && k.remove(!1, b);
            else
              !m || (e && e.enabled)
                ? (r = !1)
                : (d.forEach(function (a, d) {
            ...
            if (!J) {
              ...
              if (n && g > n)
                if (((n = t.getFirstValidPoint(d)), a(n)))
                  for (e = 0; e < g; e++)
                    (w[e] = this.autoIncrement()), (v[e] = d[e]);
                else if (b(n))
                  if (q)
                    for (e = 0; e < g; e++)
                      (f = d[e]), (w[e] = f[0]), (v[e] = f.slice(1, q + 1));
                  else
                    for (
                      E &&
                        ((C = E.indexOf("x")),
                      ...
                      (f = d[e]), (w[e] = f[C]), (v[e] = f[N]);
                else p(12, !1, m);
              else
                for (e = 0; e < g; e++)
                  "undefined" !== typeof d[e] &&
                    ((f = { series: t }),
                    t.pointClass.prototype.applyOptions.apply(f, [d[e]]),
                    t.updateParallelArrays(f, e));
              v && x(v[0]) && p(14, !0, m);
              t.data = [];
          ...
          getProcessedData: function (a) {
            ...
            for (k = d.length || 1; --k; )
              if (
                ((c = l ? a(d[k]) - a(d[k - 1]) : d[k] - d[k - 1]),
                0 < c && ("undefined" === typeof x || c < x))
              )
                var x = c;
            ...
            for (x = 0; x < h; x++) {
              ...
              if (r) {
                ...
                w.dataGroup.options &&
                  ...
                  k(w, w.dataGroup.options),
                  delete w.dataLabels);
              } else
                (w = c[u]) ||
                  "undefined" === typeof b[u] ||
                  (c[u] = w = new p().init(this, b[u], l[x]));
              w && ((w.index = u), (n[x] = w));
            }
            this.options.keys = a;
            if (c && (h !== (f = c.length) || r))
              for (x = 0; x < f; x++)
                x !== m || r || (x += h),
                  c[x] && (c[x].destroyElements(), (c[x].plotX = void 0));
            this.data = c;
            this.points = n;
            e(this, "afterGeneratePoints");
          },
          getXExtremes: function (a) {
            return { min: D(a), max: g(a) };
          },
          getExtremes: function (d, c) {
            ...
            for (n = 0; n < t; n++) {
              ...
              u =
                ...
                ((l[n + r] || u) >= h && (l[n - r] || u) <= m);
              if (v && u)
                if ((v = w.length)) for (; v--; ) a(w[v]) && (k[p++] = w[v]);
                else k[p++] = w;
            }
            d = { dataMin: D(k), dataMax: g(k) };
            e(this, "afterGetExtremes", { dataExtremes: d });
            return d;
          },
          ...
          getFirstValidPoint: function (a) {
            for (var d = null, b = a.length, c = 0; null === d && c < b; )
              (d = a[c]), c++;
            return d;
          },
          translate: function () {
            ...
            for (r = 0; r < h; r++) {
              var I = p[r],
                ...
                B =
                  ...
                  g.stacking &&
                  g.stacking.stacks[
                    (this.negStacks && D < (E ? 0 : w) ? "-" : "") +
                      this.stackKey
                  ];
              if (
                (g.positiveValuesOnly && !g.validatePositiveValue(D)) ||
                (f.positiveValuesOnly && !f.validatePositiveValue(A))
              )
                I.isNull = !0;
              I.plotX = q = v(
                H(
                  f.translate(A, 0, 0, 0, 1, n, "flags" === this.type),
                  -1e5,
                  1e5
                )
              );
              ...
              b(z) &&
                ((y = z[0]),
                (D = z[1]),
                y === E && R.key === B[A].base && (y = K(a(w) && w, g.min)),
                g.positiveValuesOnly && 0 >= y && (y = null),
                (I.total = I.stackTotal = G.total),
                (I.percentage = G.total && (I.y / G.total) * 100),
                (I.stackY = D),
                this.irregularWidths ||
                  G.setOffset(this.pointXOffset || 0, this.barW || 0));
              I.yBottom = u(y)
                ? H(g.translate(y, 0, 1, 0, 1), -1e5, 1e5)
                : null;
              m && (D = this.modifyValue(D, I));
              I.plotY =
                "number" === typeof D && Infinity !== D
                  ? H(g.translate(D, 0, 1, 0, 1), -1e5, 1e5)
                  : void 0;
              I.isInside = this.isPointInside(I);
              I.clientX = x ? v(f.translate(A, 0, 0, 0, 1, n)) : q;
              I.negative = I[C] < (d[C + "Threshold"] || w || 0);
            ...
            a && !1 === d.clip && t
              ...
              : ((a = this.clipBox || c.clipBox),
                b &&
                  ((a.width = c.plotSizeX),
                  (a.x =
                    (c.scrollablePixelsX || 0) * (l.scrollPositionX || 0))));
          ...
          setClip: function (a) {
            ...
            a &&
              ((l.width = 0),
              e && (l.x = d.plotHeight + (!1 !== b.clip ? 0 : d.plotTop)));
            g
              ? d.hasLoaded || g.attr(l)
              : (a &&
                  (d[k + "m"] = p =
                    c.clipRect(
                      e ? d.plotSizeX + 99 : -99,
            ...
            if (!1 !== b.clip || a)
              this.group.clip(a || f ? g : d.clipRect),
          ...
          animate: function (a) {
            ...
            if (!d.hasRendered)
              if (a) this.setClip(b);
                ...
                d[c + "m"] &&
                  d[c + "m"].animate(
                    { width: e.width + 99, x: e.x - (d.inverted ? 0 : 99) },
                    b
                  );
              }
          },
            ...
            if (!1 !== f.enabled || this._hasPointMarkers)
              for (c = 0; c < a.length; c++) {
                ...
                if (
                  ...
                  var n = K(m.symbol, this.symbol);
                  var x = this.markerAttribs(p, p.selected && "select");
                  this.enabledDataSorting &&
                    (p.startXPos = k.reversed ? -x.width : k.width);
                  var w = !1 !== p.isInside;
                  e
                    ? e[w ? "show" : "hide"](w).animate(x)
                    : w &&
                      (0 < x.width || p.hasImage) &&
                      ((p.graphic = e =
                        b.renderer
                          .symbol(n, x.x, x.y, x.width, x.height, r ? m : f)
                          .add(l)),
                      this.enabledDataSorting &&
                        b.hasRendered &&
                        (e.attr({ x: p.startXPos }), (h = "animate")));
                  e && "animate" === h && e[w ? "show" : "hide"](w).animate(x);
                  if (e && !b.styledMode)
                    e[h](this.pointAttribs(p, p.selected && "select"));
          ...
          pointAttribs: function (a, b) {
            ...
            c = K(
              b.lineWidth,
              d.lineWidth,
              c + K(b.lineWidthPlus, d.lineWidthPlus, 0)
            );
            l = b.fillColor || d.fillColor || l;
            f = b.lineColor || d.lineColor || f;
            a = K(b.opacity, d.opacity, a);
            return { stroke: f, "stroke-width": c, fill: l, opacity: a };
          },
          destroy: function (a) {
            var d = this,
              b = d.chart,
            ...
            (d.axisTypes || []).forEach(function (a) {
              (p = d[a]) &&
                p.series &&
                (A(p.series, d), (p.isDirty = p.forceRedraw = !0));
            });
          ...
          getZonesGraphs: function (a) {
            this.zones.forEach(function (d, b) {
              ...
              this.chart.styledMode ||
                b.push(
                  d.color || this.color,
                  d.dashStyle || this.options.dashStyle
                );
              a.push(b);
            }, this);
            return a;
          ...
          applyZones: function () {
            ...
            if (e.length && (p || h) && r && "undefined" !== typeof r.min) {
              ...
              e.forEach(function (d, e) {
                ...
                u = Math.max(f, l);
                r.isXAxis
                  ? ((g = { x: x ? u : w, y: 0, width: n, height: m }),
                    N || (g.x = b.plotHeight - g.x))
                  : ((g = { x: 0, y: x ? u : w, width: m, height: n }),
                ...
                k[e] ? k[e].animate(g) : (k[e] = c.clipRect(g));
                q = a["zone-area-" + e];
                E = a["zone-graph-" + e];
                p && E && E.clip(k[e]);
                h && q && q.clip(k[e]);
          ...
          invertGroups: function (a) {
            function d() {
              ["group", "markerGroup"].forEach(function (d) {
                b[d] &&
                  (c.renderer.isVML &&
                    b[d].attr({ width: b.yAxis.len, height: b.xAxis.len }),
                  (b[d].width = b.yAxis.len),
                  (b[d].height = b.xAxis.len),
                  b[d].invert(b.isRadialSeries ? !1 : a));
              });
            }
            var b = this,
              c = b.chart;
            b.xAxis &&
              (b.eventsToUnbind.push(m(c, "resize", d)),
              d(),
              (b.invertGroups = d));
          },
          ...
          render: function () {
            var a = this,
              ...
              c = a.options,
              f = B(c.animation),
              l = !a.finishedAnimating && b.renderer.isSVG && f.duration,
  ...
  O(
    ...
    [q["Core/Series/CartesianSeries.js"], q["Core/Globals.js"]],
    function (n, h) {
      h.Series = n;
      return h.Series;
    }
    ...
    function (n, h, q, z, y) {
        ...
        D = (function () {
          function h(g, h, m, p, k) {
            ...
            this.alignOptions = {
              ...
              verticalAlign:
                h.verticalAlign || (c ? "middle" : m ? "bottom" : "top"),
              y: h.y,
              x: h.x,
            };
            this.textAlign =
          ...
          h.prototype.render = function (g) {
            ...
            this.label
              ...
              : ((this.label = h.renderer.label(
                ...
                h.styledMode ||
                  ((p.fill = r.backgroundColor),
                  (p.stroke = r.borderColor),
                  (p["stroke-width"] = r.borderWidth),
                  this.label.css(r.style)),
                this.label.attr(p),
                this.label.added || this.label.add(g));
          ...
          h.prototype.setOffset = function (h, n, q, p, k) {
            var c = this.axis,
              e = c.chart;
            p = c.translate(
              c.stacking.usePercentage ? 100 : p ? p : this.total,
              0,
              0,
              0,
              1
            ...
            n &&
              ...
              (f =
                "left" === f
                  ...
                  ? q
                    ...
                    : -p
                  : k.width / 2),
              (q = e.inverted ? k.height / 2 : q ? -p : k.height),
              (this.alignOptions.x = m(this.options.x, 0)),
              (this.alignOptions.y = m(this.options.y, 0)),
              (c.x -= f),
              (c.y -= q),
              n.align(this.alignOptions, null, c),
              e.isInsidePlot(
                n.alignAttr.x + f - this.alignOptions.x,
                n.alignAttr.y + q - this.alignOptions.y
              )
                ? n.show()
                : ((n.alignAttr.y = -9999), (h = !1)),
              h &&
                g.prototype.justifyDataLabel.call(
                  this.axis,
                  n,
                  this.alignOptions,
                  n.alignAttr,
              ...
              n.attr({ x: n.alignAttr.x, y: n.alignAttr.y }),
              m(!h && this.options.crop, !0) &&
                ((e =
                  r(n.x) &&
                  r(n.y) &&
                  e.isInsidePlot(n.x - p + n.width, n.y) &&
                  e.isInsidePlot(n.x + p, n.y)) ||
                  n.hide()));
          };
          h.prototype.getStackBox = function (g, h, m, p, k, c, e) {
            ...
            return {
              x: b
                ? h
                  ? p - e.right
                  : p - c + e.pos - g.plotLeft
                : m + g.xAxis[0].transB - g.plotLeft,
      ...
      h.prototype.getStacks = function () {
        ...
        g.yAxis.forEach(function (g) {
          g.stacking &&
            g.stacking.stacks &&
            g.hasVisibleSeries &&
            (g.stacking.oldStacks = g.stacking.stacks);
        });
        g.series.forEach(function (r) {
          var n = (r.xAxis && r.xAxis.options) || {};
          !r.options.stacking ||
            (!0 !== r.visible && !1 !== g.options.chart.ignoreHiddenSeries) ||
            (r.stackKey = [
              r.type,
              m(r.options.stack, ""),
              h ? n.top : n.left,
      ...
      g.prototype.setGroupedPoints = function () {
        this.options.centerInCategory &&
          ...
          g.prototype.setStackedPoints.call(this, "group");
      };
      g.prototype.setStackedPoints = function (g) {
        ...
        if (
          ...
          for (K = 0; K < k; K++) {
            ...
            x[w][H] ||
              (q[w] && q[w][H]
                ? ((x[w][H] = q[w][H]), (x[w][H].total = null))
                : (x[w][H] = new D(a, a.options.stackLabels, C, H, c)));
            w = x[w][H];
            null !== y
              ? ((w.points[I] = w.points[this.index] = [m(w.cumulative, f)]),
                L(w.cumulative) || (w.base = I),
                (w.touched = a.stacking.stacksTouched),
                0 < N.index &&
                  !1 === this.singleStacks &&
                  (w.points[I][0] = w.points[this.index + "," + H + ",0"][0]))
            ...
            "percent" === h
              ? ((C = C ? g : b),
                l && x[C] && x[C][H]
                  ? ((C = x[C][H]),
                    (w.total = C.total =
                      Math.max(C.total, w.total) + Math.abs(y) || 0))
                  : (w.total = F(w.total + (Math.abs(y) || 0))))
              : "group" === h
              ? null !== y && (w.total = (w.total || 0) + 1)
              : (w.total = F(w.total + (y || 0)));
            w.cumulative =
              "group" === h
                ? (w.total || 1) - 1
                : m(w.cumulative, f) + (y || 0);
            null !== y &&
              (w.points[I].push(w.cumulative),
              (p[K] = w.cumulative),
              (w.hasValidPoints = !0));
          }
      ...
      g.prototype.modifyStacks = function () {
        var g = this,
          ...
          r = g.processedXData,
          p,
          k = g.options.stacking;
        g[k + "Stacker"] &&
          [h, "-" + h].forEach(function (c) {
            for (var e = r.length, f, b; e--; )
              if (
                ((f = r[e]),
                (p = g.getStackIndicator(p, f, g.index, c)),
                (b = (f = m[c] && m[c][f]) && f.points[p.key]))
              )
                g[k + "Stacker"](b, f, e);
          });
      };
  ...
  O(
    ...
    function (n, h, q, z, y, F, M, G, B, r) {
      ...
      y.cleanRecursively = function (b, c) {
        var e = {};
        C(b, function (d, f) {
          if (a(b[f], !0) && !b.nodeType && c[f])
            (d = y.cleanRecursively(b[f], c[f])),
              Object.keys(d).length && (e[f] = d);
      ...
      e(z.prototype, {
        addSeries: function (a, b, c) {
          ...
          a &&
            ((b = K(b, !0)),
            f(e, "addSeries", { options: a }, function () {
              d = e.initSeries(a);
              e.isDirtyLegend = !0;
              e.linkSeries();
              d.enabledDataSorting && d.setData(a.data, !1);
              f(e, "afterAddSeries", { series: d });
              b && e.redraw(c);
            }));
          return d;
        },
        ...
        createAxis: function (a, b) {
          var c = this.options,
            ...
            e = b.redraw,
            f = b.animation;
          b = E(b.axis, { index: this[a].length, isX: "xAxis" === a });
          var l = d ? new y.ColorAxis(this, b) : new h(this, b);
          c[a] = R(c[a] || {});
          c[a].push(b);
          d &&
        ...
        showLoading: function (a) {
          ...
          b.styledMode ||
            (A(d, e(f.style, { zIndex: 10 })),
            A(b.loadingSpan, f.labelStyle),
            b.loadingShown ||
        ...
        update: function (a, b, c, d) {
              ...
              R(a[b]).forEach(function (a, f) {
                ...
                k ||
                  ((k = e[b][d ? d[f] : f]) &&
                    ...
                    p(k.options.id) &&
                    (k = void 0));
                k && k.coll === b && (k.update(a, !1), c && (k.touched = !0));
                !k &&
                  c &&
          ...
          m || (l(w) && w !== e.chartWidth) || (l(k) && k !== e.chartHeight)
            ? e.setSize(w, k, d)
            : K(b, !0) && e.redraw(d);
          f(e, "afterUpdate", { options: a, redraw: b, animation: d });
        },
      ...
      e(G.prototype, {
        update: function (b, c, e, d) {
          function f() {
            ...
            m.data[h] =
              a(m.data[h], !0) || a(b, !0) ? l.options : K(b, m.data[h]);
            k.isDirty = k.isDirtyData = !0;
            !k.fixedBox && k.hasCartesianSeries && (p.isDirtyBox = !0);
            "point" === m.legendType && (p.isDirtyLegend = !0);
            c && p.redraw(e);
          }
          var l = this,
            k = l.series,
            ...
            m = k.options;
          c = K(c, !0);
          !1 === d ? f() : l.firePointEvent("update", { options: b }, f);
        },
        remove: function (a, b) {
      ...
      e(F.prototype, {
        addPoint: function (a, b, c, d, e) {
          ...
          c &&
            (k[0] && k[0].remove
              ? k[0].remove(!1)
              : (k.shift(), this.updateParallelArrays(r, "shift"), p.shift()));
          !1 !== e && f(this, "addPoint", { point: r });
        ...
        update: function (a, b) {
          a = y.cleanRecursively(a, this.userOptions);
          ...
          var l = this,
            ...
            m = !(
              ...
              l.hasOptionChanged("dataGrouping") ||
              l.hasOptionChanged("pointStart") ||
              l.hasOptionChanged("pointInterval") ||
              l.hasOptionChanged("pointIntervalUnit") ||
              l.hasOptionChanged("keys")
            ),
            r = D[g].prototype,
            n,
            x = ["eventOptions", "navigatorSeries", "baseSeries"],
            q = l.finishedAnimating && { animation: !1 },
            u = {};
          m &&
            (x.push(
              "data",
            ...
            !1 !== a.visible && x.push("area", "graph"),
            l.parallelArrays.forEach(function (a) {
              x.push(a + "Data");
            }),
            a.data &&
              (a.dataSorting && e(l.options.dataSorting, a.dataSorting),
          ...
          if (m && this.points) {
            ...
            !1 === C.visible
              ...
              : l._hasPointLabels ||
                ((a = C.marker),
                (k = C.dataLabels),
                a && (!1 === a.enabled || "symbol" in a) && (u.graphic = 1),
                k && !1 === k.enabled && (u.dataLabel = 1));
      ...
      e(h.prototype, {
        update: function (a, b) {
          ...
          this.destroy(!0);
          this.init(c, e(a, { events: d }));
          c.isDirtyBox = !0;
          K(b, !0) && c.redraw();
        },
        remove: function (a) {
          for (
            var c = this.chart, e = this.coll, d = this.series, f = d.length;
            f--;
        ...
        { threshold: 0 },
        {
          ...
          getStackPoints: function (h) {
            ...
            if (this.options.stacking) {
              for (e = 0; e < h.length; e++)
                (h[e].leftNull = h[e].rightNull = void 0), (u[h[e].x] = h[e]);
              L(q, function (b, c) {
                null !== b.total && g.push(c);
              });
              g.sort(function (b, c) {
                return b - c;
              });
          ...
          getGraphPath: function (h) {
            ...
            for (q = 0; q < h.length; q++) {
              ...
              if (!b || g)
                g || f(q, q - 1, "left"),
                  (b && !r && g) ||
                    (A.push(h[q]), u.push({ x: q, plotX: l, plotY: a })),
                  g || f(q, q + 1, "right");
            }
            q = m.call(this, A, !0, !0);
            u.reversed = !0;
          ...
          drawGraph: function () {
            ...
            var h = this,
              m = this.areaPath,
              g = this.options,
              n = [["area", "highcharts-area", this.color, g.fillColor]];
            this.zones.forEach(function (m, r) {
              n.push([
                "zone-area-" + r,
                "highcharts-area highcharts-zone-area-" + r + " " + m.className,
                m.color || h.color,
                m.fillColor || g.fillColor,
              ]);
            });
            n.forEach(function (r) {
              var n = r[0],
                ...
                p = {};
              q
                ? ((q.endX = h.preventGraphAnimation ? null : m.xMap),
                  q.animate({ d: m }))
                : ((p.zIndex = 0),
                  (q = h[n] =
                    h.chart.renderer.path(m).addClass(r[1]).add(h.group)),
                  (q.isArea = !0));
              h.chart.styledMode ||
                (p.fill = G(
                  r[3],
                  F(r[2]).setOpacity(G(g.fillOpacity, 0.75)).get()
                ));
              q[A](p);
              q.startX = m.xMap;
  ...
  O(
    ...
    [q["Core/Series/Series.js"], q["Core/Utilities.js"]],
    function (n, h) {
      var q = h.pick;
      n.seriesType(
        "spline",
        ...
        {},
        {
          getPointSpline: function (h, n, F) {
            ...
            if (
              ...
              H += m;
              D > h && D > G
                ? ((D = Math.max(h, G)), (H = 2 * G - D))
                : D < h && D < G && ((D = Math.min(h, G)), (H = 2 * G - D));
              H > F && H > G
                ? ((H = Math.max(F, G)), (D = 2 * G - H))
                : H < F && H < G && ((H = Math.min(F, G)), (D = 2 * G - H));
              n.rightContX = r;
              n.rightContY = H;
            }
            n = [
              "C",
              q(B.rightContX, B.plotX, 0),
              q(B.rightContY, B.plotY, 0),
              q(g, y, 0),
              q(D, G, 0),
              y,
              G,
      ...
      h = h.seriesType(
        ...
        },
        {
          ...
          getColumnMetrics: function () {
            ...
            !1 === k.grouping
              ? (a = 1)
              : g.chart.series.forEach(function (c) {
                  var f = c.yAxis,
                    k = c.options;
                  if (
                    c.type === g.type &&
                    (c.visible || !g.chart.options.chart.ignoreHiddenSeries) &&
                    e.len === f.len &&
                    e.pos === f.pos
                  ) {
            ...
            var h = Math.min(
              ...
              r = (h - 2 * m) / (a || 1);
            k = Math.min(
              k.maxPointWidth || c.len,
              u(k.pointWidth, r * (1 - 2 * k.pointPadding))
            );
            g.columnMetrics = {
              width: k,
              offset:
                (r - k) / 2 +
                (m + ((g.columnIndex || 0) + (f ? 1 : 0)) * r - h / 2) *
                  (f ? -1 : 1),
              paddedWidth: r,
              columnCount: a,
            };
          ...
          crispCol: function (g, k, c, e) {
            ...
            this.options.crisp &&
              ((c = Math.round(g + c) + l), (g = Math.round(g) + l), (c -= g));
            e = Math.round(k + e) + b;
            l = 0.5 >= Math.abs(k) && 0.5 < e;
            k = Math.round(k) + b;
            e -= k;
            l && e && (--k, (e += 1));
            return { x: g, y: k, width: c, height: e };
          },
          ...
          translate: function () {
            ...
            g.points.forEach(function (e) {
              ...
              if (h && Math.abs(I) < h) {
                I = h;
                var y =
                  (!b.reversed && !e.negative) || (b.reversed && e.negative);
                H(l) &&
                  H(N) &&
                  e.y === l &&
                  N <= l &&
              ...
              m(e.options.pointWidth) &&
                ((t = C = Math.ceil(e.options.pointWidth)),
                (E -= Math.round((t - q) / 2)));
              c.centerInCategory && (E = g.adjustForMissingColumns(E, t, e, n));
              e.barX = E;
              e.pointWidth = t;
              e.tooltipPos = k.inverted
                ? [
                    b.len + b.pos - k.plotLeft - d,
                    f.len + f.pos - k.plotTop - (x || 0) - A - C / 2,
                    I,
                  ]
                : [E + C / 2, d + b.pos - k.plotTop, I];
              e.shapeType = g.pointClass.prototype.shapeType || "rect";
              e.shapeArgs = g.crispCol.apply(
                g,
                e.isNull ? [E, a, C, 0] : [E, K, C, I]
              );
            });
          },
          getSymbol: n,
          ...
          pointAttribs: function (g, k) {
            ...
            k &&
              ...
              ((g = v(
                c.states[k],
                (g.options.states && g.options.states[k]) || {}
              )),
              (k = g.brightness),
              (l =
                g.color ||
                ("undefined" !== typeof k &&
                  B(l).brighten(g.brightness).get()) ||
                l),
              (a = g[f] || a),
              (h = g[b] || h),
              (e = g.dashStyle || e),
              (p = u(g.opacity, p)));
            f = { fill: l, stroke: a, "stroke-width": h, opacity: p };
            e && (f.dashstyle = e);
            return f;
          },
          drawPoints: function () {
            ...
            g.points.forEach(function (l) {
              ...
              if (H(l.plotY) && null !== l.y) {
                ...
                g.enabledDataSorting &&
                  (l.startXPos = g.xAxis.reversed
                    ? -(b ? b.width : 0)
                    : g.xAxis.width);
                a ||
                  ((l.graphic = a =
                    e[l.shapeType](b).add(l.group || g.group)) &&
                    g.enabledDataSorting &&
                    k.hasRendered &&
                    k.pointCount < f &&
                    (a.attr({ x: l.startXPos }), (h = !0), (p = "animate")));
                if (a && h) a[p](v(b));
                if (c.borderRadius) a[p]({ r: c.borderRadius });
                k.styledMode ||
                  a[p](g.pointAttribs(l, l.selected && "select")).shadow(
                    !1 !== l.allowShadow && c.shadow,
                    null,
          ...
          animate: function (h) {
            ...
            if (h)
              (b.scaleY = 0.001),
                (h = r(c.toPixels(e.threshold), c.pos, c.pos + c.len)),
                f ? (b.translateX = h - c.len) : (b.translateY = h),
                k.clipBox && k.setClip(),
                k.group.attr(b);
            else {
              ...
              k.group.animate(
                ...
                g(G(k.options.animation), {
                  step: function (e, f) {
                    k.group &&
                      ((b[l] = a + f.pos * (c.pos - a)), k.group.attr(b));
                  },
                })
              );
            }
  ...
  O(
    ...
    [q["Core/Series/Series.js"], q["Core/Globals.js"], q["Core/Utilities.js"]],
    function (n, h, q) {
      q = q.addEvent;
      var z = h.Series;
      n.seriesType(
        ...
        },
        {
          ...
          applyJitter: function () {
            ...
            n &&
              this.points.forEach(function (y, B) {
      ...
      return (n.CenteredSeriesMixin = {
        getCenter: function () {
          ...
          h = [
            z(g[0], "50%"),
            z(g[1], "50%"),
            z(H && 0 > H ? void 0 : h.size, "100%"),
            z(v && 0 > v ? void 0 : h.innerSize || 0, "0%"),
          ];
          !q.angular || this instanceof n.Series || (h[3] = 0);
          for (g = 0; 4 > g; ++g)
            (H = h[g]),
              (q = 2 > g || (2 === g && /%$/.test(H))),
              (h[g] = y(H, [r, m, D, h[2]][g]) + (q ? B : 0));
          h[3] > h[2] && (h[3] = h[2]);
          return h;
        },
        getStartAndEndRadians: function (h, n) {
          ...
          return { start: F * (h + -90), end: F * (n + -90) };
        },
      });
    }
  );
      ...
      h.seriesType(
        ...
        },
        {
          ...
          getX: function (c, e, f) {
            ...
            return (
              b[0] +
              (e ? -1 : 1) * Math.cos(c) * (g + f.labelDistance) +
              (0 < f.labelDistance
          ...
          translate: function (c) {
            ...
            for (q = 0; q < u; q++) {
              ...
              A.tooltipPos = [c[0] + 0.7 * w, c[1] + 0.7 * d];
              A.half = I < -Math.PI / 2 || I > Math.PI / 2 ? 1 : 0;
              A.angle = I;
              D = Math.min(g, A.labelDistance / 5);
              A.labelPosition = {
                natural: {
                  x: c[0] + w + Math.cos(I) * A.labelDistance,
                ...
                connectorPosition: {
                  ...
                  touchingSliceAt: { x: c[0] + w, y: c[1] + d },
                },
              };
            }
          ...
          redrawPoints: function () {
            ...
            !h ||
              c.shadowGroup ||
              e.styledMode ||
              (c.shadowGroup = f.g("shadow").attr({ zIndex: -1 }).add(c.group));
            c.points.forEach(function (l) {
              ...
              if (!l.isNull && g) {
                ...
                if (!e.styledMode) {
                  ...
                  h &&
                    !m &&
                    (m = l.shadowGroup = f.g("shadow").add(c.shadowGroup));
                  m && m.attr(b);
                  a = c.pointAttribs(l, l.selected && "select");
                }
                l.delayedRendering
                  ? (g.setRadialReference(c.center).attr(k).attr(b),
                    e.styledMode ||
                      g
                        .attr(a)
                  ...
                  : (g.setRadialReference(c.center),
                    e.styledMode || A(!0, p, a),
                    A(!0, p, k, b),
                    g.animate(p));
          ...
          drawPoints: function () {
            ...
            this.points.forEach(function (e) {
              ...
              e.graphic ||
                ((e.graphic = c[e.shapeType](e.shapeArgs).add(e.series.group)),
        ...
        },
        {
          ...
          setVisible: function (c, e) {
            ...
            c !== f.visible &&
              ((f.visible =
                f.options.visible =
                c =
                  "undefined" === typeof c ? !f.visible : c),
              ...
              f.legendItem && g.legend.colorizeItem(f, c),
              c || "hover" !== f.state || f.setState(""),
              a && (b.isDirty = !0),
              e && g.redraw());
          },
          ...
          connectorShapes: {
            ...
            crookedLine: function (c, e, f) {
              ...
              f = ["L", a, c.y];
              g = !0;
              if ("left" === b ? a > c.x || a < e.x : a < c.x || a > e.x)
                g = !1;
              c = [["M", c.x, c.y]];
              g && c.push(f);
              c.push(["L", e.x, e.y]);
  ...
  O(
    ...
    [
      q["Core/Animation/AnimationUtilities.js"],
      q["Core/Globals.js"],
      q["Core/Series/CartesianSeries.js"],
      q["Core/Utilities.js"],
    ],
    function (n, h, q, z) {
      ...
      h.distribute = function (c, e, f) {
        ...
        for (
          ...
          for (g = c.length; g--; )
            (a = c[g]),
              (r =
                (Math.min.apply(0, a.targets) + Math.max.apply(0, a.targets)) /
                2),
              (a.pos = G(r - a.size * a.align, 0, e - a.size));
          g = c.length;
          for (a = !1; g--; )
            0 < g &&
              c[g - 1].pos + c[g - 1].size > c[g].pos &&
              ((c[g - 1].size += c[g].size),
              (c[g - 1].targets = c[g - 1].targets.concat(c[g].targets)),
              (c[g - 1].align = 0.5),
              c[g - 1].pos + c[g - 1].size > e &&
                (c[g - 1].pos = e - c[g - 1].size),
              c.splice(g, 1),
              (a = !0));
        }
        p.push.apply(p, m);
        ...
        c.some(function (a) {
          ...
          if (
            a.targets.some(function () {
              ...
              if (
                "undefined" !== typeof f &&
                Math.abs(p[g].pos - p[g].target) > f
              )
                return (
                  p.slice(0, g + 1).forEach(function (a) {
                    delete a.pos;
                  }),
                  (p.reducedLen = (p.reducedLen || e) - 0.1 * e),
                  p.reducedLen > 0.1 * e && h.distribute(p, e, f),
                  !0
                );
              b += p[g].size;
              g++;
      ...
      q.prototype.drawDataLabels = function () {
        ...
        var f = this,
          ...
          n = f.hasRendered || 0,
          q = a.animation;
        q = a.defer ? y(b, q, f) : { defer: 0, duration: 0 };
        var A = b.renderer;
        a = e(
          e(
            ...
            b.options.plotOptions &&
              b.options.plotOptions[f.type] &&
              b.options.plotOptions[f.type].dataLabels
          ),
          a
        );
        ...
        if (D(a) || a.enabled || f._hasPointLabels) {
          ...
          !n &&
            (n = f.dataLabelsGroup) &&
            (f.visible && z.show(!0),
            n[k.animation ? "animate" : "attr"]({ opacity: 1 }, q));
          h.forEach(function (l) {
            ...
            r.forEach(function (a, e) {
              ...
              if (d) {
                ...
                n = B(q)
                  ? g(q, n, b)
                  : (a[l.formatPrefix + "Formatter"] || a.formatter).call(n, a);
                q = a.style;
                var x = a.rotation;
                b.styledMode ||
                  ((q.color = u(a.color, q.color, f.color, "#000000")),
                  "contrast" === q.color
                    ? ((l.contrastColor = A.getContrast(l.color || f.color)),
                      (q.color =
                        (!B(m) && a.inside) || 0 > m || k.stacking
                          ? l.contrastColor
                          : "#000000"))
                    : delete l.contrastColor,
                ...
                b.styledMode ||
                  ((w.fill = a.backgroundColor),
                  (w.stroke = a.borderColor),
              ...
              !h || (d && B(n))
                ? d &&
                  ...
                  (h
                    ? (w.text = n)
                    : ((l.dataLabels = l.dataLabels || []),
                      (h = l.dataLabels[e] =
                        x
                          ? A.text(n, 0, -9999, a.useHTML).addClass(
                  ...
                  (h.options = a),
                  h.attr(w),
                  b.styledMode || h.css(q).shadow(a.shadow),
                  h.added || h.add(z),
                  a.textPath &&
                    !a.useHTML &&
                    (h.setTextPath(
                      (l.getDataLabelPath && l.getDataLabelPath(h)) ||
                        l.graphic,
                      a.textPath
                    ),
                    l.dataLabelPath &&
                      !a.textPath.enabled &&
                      (l.dataLabelPath = l.dataLabelPath.destroy())),
                  f.alignDataLabel(l, h, a, null, r))
                : ((l.dataLabel = l.dataLabel && l.dataLabel.destroy()),
                  l.dataLabels &&
                    (1 === l.dataLabels.length
                      ? delete l.dataLabels
                      : delete l.dataLabels[e]),
                  e || delete l.dataLabel,
                  p &&
                    ((l.connector = l.connector.destroy()),
                    l.connectors &&
                      (1 === l.connectors.length
                        ? delete l.connectors
                        : delete l.connectors[e])));
            });
          });
        }
        ...
        var a = this,
          ...
          t =
            ...
            (c.series.forceDL ||
              ...
              (f.inside &&
                b &&
                l.isInsidePlot(p, k ? b.x + 1 : b.y + b.height - 1, k)));
        var A = function (b) {
          h && a.xAxis && !d && a.setDataLabelStartPos(c, e, g, w, b);
        };
        if (t) {
          var D = l.renderer.fontMetrics(
            l.styledMode ? void 0 : f.style.fontSize,
            e
          ).b;
          b = r(
            {
          ...
          r(f, { width: n.width, height: n.height });
          q
            ? ((d = !1),
              (p = l.renderer.rotCorr(D, q)),
              (p = {
              ...
              A(p),
              e[g ? "attr" : "animate"](p).attr({ align: v }),
              (A = (q + 720) % 360),
              (A = 180 < A && 360 > A),
              "left" === v
                ? (p.y -= A ? n.height : 0)
                : "center" === v
                ? ((p.x -= n.width / 2), (p.y -= n.height / 2))
                : "right" === v &&
                  ((p.x -= n.width), (p.y -= A ? 0 : n.height)),
              (e.placed = !0),
              (e.alignAttr = p))
            : (A(b), e.align(f, null, b), (p = e.alignAttr));
          d && 0 <= b.height
            ? this.justifyDataLabel(e, f, p, n, b, g)
            : u(f.crop, !0) &&
              (t =
                l.isInsidePlot(p.x, p.y) &&
                l.isInsidePlot(p.x + n.width, p.y + n.height));
          if (f.shape && !q)
            e[g ? "attr" : "animate"]({
      ...
      q.prototype.setDataLabelStartPos = function (c, e, f, b, g) {
        ...
        a.hasRendered &&
          (f && e.attr({ x: e.startXPos, y: e.startYPos }), (e.placed = !0));
      };
      ...
      F.pie &&
        ((F.pie.prototype.dataLabelPositioners = {
          ...
          radialDistributionX: function (c, e, f, b) {
        ...
        (F.pie.prototype.drawDataLabels = function () {
          ...
          c.visible &&
            ...
            q.prototype.drawDataLabels.apply(c),
            e.forEach(function (a) {
              a.dataLabel &&
                (a.visible
                  ? (G[a.half].push(a),
              ...
              if (l) {
                ...
                if (0 < c.maxLabelDistance) {
                  ...
                  e.forEach(function (a) {
                    0 < a.labelDistance &&
                      a.dataLabel &&
                      ((a.top = Math.max(0, w - D - a.labelDistance)),
                      (a.bottom = Math.min(
                        w + D + a.labelDistance,
                        b.plotHeight
                      )),
                ...
                for (X = 0; X < l; X++) {
                  ...
                  d._attr = { visibility: O, align: y.alignment };
                  U = f.options.dataLabels || {};
                  d._pos = {
                    x:
                      F +
                      u(U.x, g.x) +
                      ({ left: a, right: -a }[y.alignment] || 0),
                    y: M + u(U.y, g.y) - 10,
                  };
                  y.final.x = F;
                  y.final.y = M;
                  u(g.crop, !0) &&
                    ...
                    F - t < a && 1 === k
                      ...
                      : F + t > p - a &&
                        0 === k &&
                        ((x = Math.round(F + t - p + a)),
                        (S[1] = Math.max(x, S[1]))),
                    0 > M - z / 2
                      ? (S[0] = Math.max(Math.round(-M + z / 2), S[0]))
                      : M + z / 2 > m &&
                        (S[2] = Math.max(Math.round(M + z / 2 - m), S[2])),
                    (d.sideOverflow = x));
                }
              }
            }),
            0 === L(S) || this.verifyDataLabelOverflow(S)) &&
            ...
            this.points.forEach(function (a) {
              ...
              if ((k = u(U.connectorWidth, 1))) {
                ...
                if (
                  ...
                  v[e ? "attr" : "animate"]({ d: a.getConnectorPath() });
                  v.attr("visibility", O);
            ...
            e &&
              ...
              ((f = e._pos)
                ? (e.sideOverflow &&
                    ...
                    (e.shortened = !0)),
                  e.attr(e._attr),
                  e[e.moved ? "animate" : "attr"](f),
                  (e.moved = !0))
                : e && e.attr({ y: -9999 }));
            delete c.distributeBox;
          }, this);
        }),
        (F.pie.prototype.alignDataLabel = n),
        (F.pie.prototype.verifyDataLabelOverflow = function (c) {
          var e = this.center,
            f = this.options,
            b = f.center,
            g = f.minSize || 80,
          ...
          if (!a) {
            if (null !== b[0]) var k = Math.max(e[2] - Math.max(c[1], c[3]), g);
              ...
              (k = Math.max(e[2] - c[1] - c[3], g)),
                (e[0] += (c[3] - c[1]) / 2);
            null !== b[1]
              ? (k = G(k, g, e[2] - Math.max(c[0], c[2])))
              : ((k = G(k, g, e[2] - c[0] - c[2])),
                (e[1] += (c[0] - c[2]) / 2));
            k < e[2]
              ? ((e[2] = k),
                (e[3] = Math.min(A(f.innerSize || 0, k), k)),
                this.translate(e),
      ...
      F.column &&
        (F.column.prototype.alignDataLabel = function (c, e, f, b, g) {
          ...
          l &&
            ...
            (l = b.y + b.height - k.yAxis.len),
            0 < l && l < b.height && (b.height -= l),
            a &&
              (b = {
                x: k.yAxis.len - b.y - b.height,
            ...
            p ||
              (a
                ? ((b.x += h ? 0 : b.width), (b.width = 0))
                : ((b.y += h ? b.height : 0), (b.height = 0))));
          f.align = u(f.align, !a || p ? "center" : h ? "right" : "left");
          f.verticalAlign = u(
            f.verticalAlign,
            a || p ? "middle" : h ? "top" : "bottom"
          );
          q.prototype.alignDataLabel.call(this, c, e, f, b, g);
          f.inside && c.contrastColor && e.css({ color: c.contrastColor });
        });
    }
  );
  O(
    ...
    [q["Core/Chart/Chart.js"], q["Core/Utilities.js"]],
    function (n, h) {
      var q = h.addEvent,
        z = h.fireEvent,
        y = h.isArray,
      ...
      q(n, "render", function () {
        ...
        (this.yAxis || []).forEach(function (r) {
          r.stacking &&
            ...
            !r.options.stackLabels.allowOverlap &&
            M(r.stacking.stacks, function (m) {
              M(m, function (g) {
                h.push(g.label);
              });
            });
        ...
        (this.series || []).forEach(function (r) {
          ...
          r.visible &&
            (!1 !== m.enabled || r._hasPointLabels) &&
            (r.nodes || r.points).forEach(function (g) {
              g.visible &&
                (y(g.dataLabels)
                  ? g.dataLabels
                  : g.dataLabel
        ...
        var A = function (c) {
          ...
          if (c && (!c.alignAttr || c.placed)) {
            ...
            c.width ||
              ...
              (c.width = e.width),
              (c.height = e.height),
              (e = g.fontMetrics(null, c.element).h));
            var p = c.width - 2 * f;
            (k = { left: "0", center: "0.5", right: "1" }[c.alignValue])
              ? (b = +k * p)
              : F(c.x) &&
        ...
        for (q = 0; q < m; q++) {
          ...
          for (n = q + 1; n < m; ++n) {
            ...
            !p ||
              ...
              k.y >= p.y + p.height ||
              k.y + k.height <= p.y ||
              ((A.labelrank < v.labelrank ? A : v).newOpacity = 0);
          }
        }
            ...
            c.oldOpacity !== e &&
              (c.alignAttr && c.placed
                ? (c[e ? "removeClass" : "addClass"](
                  ...
                  (u = !0),
                  (c.alignAttr.opacity = e),
                  c[c.isOld ? "animate" : "attr"](
                    c.alignAttr,
                    null,
                    function () {
                      r.styledMode ||
                        c.css({ pointerEvents: e ? "auto" : "none" });
                      c.visibility = e ? "inherit" : "hidden";
                    }
                  ),
                  z(r, "afterHideOverlappingLabel"))
                : c.attr({ opacity: e }));
            c.isOld = !0;
          }
        });
      ...
      q = q.TrackerMixin = {
        ...
        drawTrackerGraph: function () {
          var a = this,
            ...
            d = "rgba(192,192,192," + (r ? 0.0001 : 0.002) + ")";
          h
            ? h.attr({ d: e })
            : a.graph &&
              ((a.tracker = k
        ...
        showResetZoom: function () {
          ...
          A(this, "beforeShowResetZoom", null, function () {
            b.resetZoomButton = b.renderer
              .button(c.resetZoom, null, null, a, f, g && g.hover)
        ...
        zoom: function (a) {
          ...
          !a || a.resetSelection
            ...
            : a.xAxis.concat(a.yAxis).forEach(function (a) {
                ...
                f[h ? "zoomX" : "zoomY"] &&
                  p &&
                  ((c = e.zoom(a.min, a.max)), e.displayBtn && (g = !0));
              });
          var h = b.resetZoomButton;
          g && !h
            ? b.showResetZoom()
            : !g && e(h) && (b.resetZoomButton = h.destroy());
          c &&
            b.redraw(
              l(b.options.chart.animation, a && a.animation, 100 > b.pointCount)
            );
        },
        pan: function (a, b) {
          var e = this,
          ...
          var p = b.type;
          A(this, "pan", { originalEvent: a }, function () {
            f &&
              f.forEach(function (a) {
                a.setState();
              });
            ...
            b.forEach(function (b) {
              ...
              var m = e[f],
                r = (d.pointRange || 0) / 2,
                n =
                  (d.reversed && !e.inverted) || (!d.reversed && e.inverted)
                    ? -1
                    : 1,
                q = d.getExtremes(),
              ...
              n = Math.min(
                l(null === v || void 0 === v ? void 0 : v.startMin, q.dataMin),
                r ? q.min : d.toValue(d.toPixels(q.min) - d.minPixelPadding)
              );
              r = Math.max(
                l(null === v || void 0 === v ? void 0 : v.startMax, q.dataMax),
                r ? q.max : d.toValue(d.toPixels(q.max) + d.minPixelPadding)
              );
              d.panningState = v;
              d.isOrdinal ||
                ((x = n - m),
                ...
                d.series.length &&
                  ...
                  m >= n &&
                  u <= r &&
                  (d.setExtremes(m, u, !1, !1, { trigger: "pan" }),
                  e.resetZoomButton ||
                    k ||
                    m === n ||
                    u === r ||
                    !p.match("y") ||
                    (e.showResetZoom(), (d.displayBtn = !1)),
                  (h = !0)),
                (e[f] = g));
            });
            h && e.redraw(!1);
              ...
              b ||
                f.getSelectedPoints().forEach(function (a) {
                  ...
                  a.selected &&
                    ...
                    a.setState(
                      f.hoverPoints && b.options.inactiveOtherPoints
                        ? "inactive"
                        : ""
                    ),
        ...
        setState: function (a, b) {
          ...
          if (
            !(
              ...
              !1 === f.enabled ||
              (a && (p || (k && !1 === h.enabled))) ||
              (a && d.states && d.states[a] && !1 === d.states[a].enabled)
            )
          ) {
            this.state = a;
              ...
              if (!t.styledMode) {
                ...
                c.options.inactiveOtherPoints &&
                  ...
                  ((this.dataLabels || []).forEach(function (a) {
                    a && a.animate({ opacity: v.opacity }, y);
                  }),
                  this.connector &&
                    this.connector.animate({ opacity: v.opacity }, y));
                this.graphic.animate(v, y);
              }
              q &&
                this.graphic.animate(
                  q,
                  l(t.options.chart.animation, h.animation, g.animation)
                );
              r && r.hide();
            } else {
              if (a && h) {
                ...
                if (q)
                  if (r) r[b ? "animate" : "attr"]({ x: q.x, y: q.y });
                  else
                    e &&
                      ((c.stateMarkerGraphic = r =
                        t.renderer
                          .symbol(e, q.x, q.y, q.width, q.height)
                          .add(c.markerGroup)),
                      (r.currentSymbol = e));
            ...
            a && a.size && r && "hidden" !== f && !this.isCluster
              ? (n || (c.halo = n = t.renderer.path().add(r.parentGroup)),
                n.show()[b ? "animate" : "attr"]({ d: this.haloPath(a.size) }),
                n.attr({
                  class:
                    "highcharts-halo highcharts-color-" +
                    l(this.colorIndex, c.colorIndex) +
      ...
      u(y.prototype, {
        ...
        setState: function (a, b) {
          ...
          if (
            ...
            a &&
              ((h = k[a].lineWidth || h + (k[a].lineWidthPlus || 0)),
              (p = l(k[a].opacity, p)));
            if (f && !f.dashstyle)
              for (
                k = { "stroke-width": h }, f.animate(k, m);
                c["zone-graph-" + e];

              )
                c["zone-graph-" + e].attr(k), (e += 1);
            g ||
              [
                c.group,
                c.markerGroup,
  ...
  O(
    ...
    function (n, h) {
      ...
      n.prototype.setResponsive = function (h, g) {
        ...
        n = n.toString() || void 0;
        n !== (v && v.ruleIds) &&
          (v && this.update(v.undoOptions, h, !0),
          n
            ? ((v = this.currentOptions(g)),
        ...
        function g(h, r, n, p) {
          ...
          M(h, function (c, e) {
            if (!p && -1 < m.collectionsWithUpdate.indexOf(e))
              for (
                c = B(c), n[e] = [], k = 0;
                k < Math.max(c.length, r[e].length);
                k++
              )
                r[e][k] &&
                  (void 0 === c[k]
                    ? (n[e][k] = r[e][k])
                    : ((n[e][k] = {}), g(c[k], r[e][k], n[e][k], p + 1)));
            else
              y(c)
                ? ((n[e] = z(c) ? [] : {}), g(c, r[e] || {}, n[e], p + 1))
                : (n[e] = "undefined" === typeof r[e] ? null : r[e]);
          });
        }
        var m = this,
          r = {};
        ...
        h.compose = function (h) {
            ...
            if (this.mapAxis) {
              ...
              if (this.isXAxis) {
                ...
                this.series.forEach(function (g, q) {
                  g.useMapGeometry &&
                    ((r = Math.min(r, z(g.minX, r))),
                    (m = Math.max(m, z(g.maxX, m))),
                    (g.xData = h[q]),
                    (n = !0));
                });
          ...
          q(h, "afterSetAxisTranslation", function () {
            if (this.mapAxis) {
              ...
              var r;
              "yAxis" === this.coll &&
                "undefined" !== typeof h.transA &&
                this.series.forEach(function (h) {
                  h.preserveAspectRatio && (r = !0);
                });
              if (
                r &&
                ((this.transA = h.transA = Math.min(this.transA, h.transA)),
                (n /= (h.max - h.min) / (this.max - this.min)),
                (n = 1 > n ? this : h),
                (h = (n.max - n.min) * n.transA),
                (n.mapAxis.pixelPadding = n.len - h),
                (n.minPixelPadding = n.mapAxis.pixelPadding / 2),
                (h = n.mapAxis.fixTo))
              ) {
                h = h[1] - n.toValue(h[0], !0);
                h *= n.transA;
                if (
                  Math.abs(h) > n.minPixelPadding ||
                  (n.min === n.dataMin && n.max === n.dataMax)
                )
                  h = 0;
                n.minPixelPadding -= h;
              }
  ...
  O(q, "Mixins/ColorSeries.js", [], function () {
    return {
      colorPointMixin: {
        ...
        translateColors: function () {
          ...
          (this.data.length ? this.data : this.points).forEach(function (y) {
            ...
            (F =
              ...
              y.color !== F &&
              ((y.color = F),
              "point" === n.options.legendType &&
                y.legendItem &&
                n.chart.legend.colorizeItem(y, y.visible));
          });
        },
      },
    };
  ...
  O(
    ...
    [
      ...
      q["Core/Chart/Chart.js"],
      q["Core/Color/Color.js"],
      q["Mixins/ColorSeries.js"],
      q["Core/Animation/Fx.js"],
      q["Core/Globals.js"],
      q["Core/Legend.js"],
      q["Mixins/LegendSymbol.js"],
      q["Series/LineSeries.js"],
    ...
    function (n, h, q, z, y, F, M, G, B, r, m) {
      var g =
          (this && this.__extends) ||
          (function () {
            var b = function (c, a) {
      ...
      var f = (function (b) {
        ...
        e.buildOptions = function (a, b, c) {
          a = a.options.legend || {};
          var e = c.layout ? "vertical" !== c.layout : "vertical" !== a.layout;
          return k(b, { side: e ? 2 : 1, reversed: !e }, c, {
            opposite: !e,
            showEmpty: !1,
            title: null,
          ...
          a.dataClasses.forEach(function (a, l) {
            ...
            if (b.styledMode || !a.color)
              "category" === g.dataClassColor
                ? (b.styledMode ||
                    ((l = b.options.colors), (f = l.length), (a.color = l[e])),
                  (a.colorIndex = e),
                  e++,
                  e === f && (e = 0))
                : (a.color = D(g.minColor).tweenTo(
                    D(g.maxColor),
                    2 > h ? 0.5 : l / (h - 1)
                  ));
          });
        ...
        e.prototype.setAxisSize = function () {
          ...
          a
            ? ((this.left = c = a.attr("x")),
              ...
              (this.right = b.chartWidth - c - g),
              (this.bottom = b.chartHeight - f - a),
              (this.len = this.horiz ? g : a),
              (this.pos = this.horiz ? c : f))
            : (this.len =
                (this.horiz ? c.symbolWidth : c.symbolHeight) ||
          ...
          if (c)
            for (f = c.length; f--; ) {
              ...
              if (
                ...
                var h = g.color;
                b && ((b.dataClass = f), (b.colorIndex = g.colorIndex));
                break;
              }
            }
          else {
        ...
        e.prototype.drawLegendSymbol = function (a, b) {
          ...
          b.legendSymbol = this.chart.renderer
            .rect(0, a.baseline - 11, h, l)
            .attr({ zIndex: 1 })
            .add(b.legendGroup);
          this.legendItemWidth = h + f + (k ? g : p);
        ...
        e.prototype.getSeriesExtremes = function () {
          ...
          for (this.dataMax = -Infinity; b--; ) {
            ...
            h
              ? ((f.minColorValue = f[g + "Min"]),
                (f.maxColorValue = f[g + "Max"]))
              : ((l = B.prototype.getExtremes.call(f, l)),
                (f.minColorValue = l.dataMin),
                (f.maxColorValue = l.dataMax));
        ...
        e.prototype.getPlotLinePath = function (a) {
          ...
          return p(e)
            ? this.horiz
              ? [["M", e - 4, f - 6], ["L", e + 4, f - 6], ["L", e, f], ["Z"]]
              : [["M", c, e], ["L", c - 6, e + 6], ["L", c - 6, e - 6], ["Z"]]
        ...
        e.prototype.getDataClassLegendSymbols = function () {
          var a = this,
            ...
            k;
          c.length ||
            a.dataClasses.forEach(function (e, h) {
              var l = !0,
                d = e.from,
                p = e.to,
                m = b.numberFormatter;
      ...
      v(h, "afterGetAxes", function () {
        ...
        this.colorAxis = [];
        c.colorAxis &&
          ((c.colorAxis = e(c.colorAxis)),
          c.colorAxis.forEach(function (a, c) {
            a.index = c;
            new f(b, a);
          }));
      });
      ...
      v(M, "afterGetAllItems", function (b) {
        ...
        (this.chart.colorAxis || []).forEach(function (e) {
          (a = e.options) &&
            a.showInLegend &&
            (a.dataClasses && a.visible
              ? (c = c.concat(e.getDataClassLegendSymbols()))
              : a.visible && c.push(e),
            e.series.forEach(function (c) {
              if (!c.options.showInLegend || a.dataClasses)
    ...
    function (n, h, q) {
      ...
      return {
        colorMapPointMixin: {
          ...
          setState: function (n) {
            h.prototype.setState.call(this, n);
            this.graphic &&
              this.graphic.attr({ zIndex: "hover" === n ? 1 : 0 });
          },
        },
        colorMapSeriesMixin: {
          pointArrayMap: ["value"],
  ...
  O(
    ...
    function (n, h, q) {
      ...
      y.prototype.update = function (g) {
        ...
        m(n.enableButtons, n.enabled) &&
          !h.renderer.forExport &&
          r(n.buttons, function (f, b) {
            q = B(n.buttonOptions, f);
            h.styledMode ||
              ((u = q.theme),
              (u.style = B(q.theme.style, q.style)),
              (p = (A = u.states) && A.hover),
              (k = A && A.select));
            f = h.renderer
              .button(
                q.text,
              ...
              .add();
            f.handler = q.onclick;
            L(f.element, "dblclick", z);
            e.push(f);
            var g = q,
              a = L(h, "load", function () {
                f.align(
                  G(g, { width: f.width, height: 2 * f.height }),
                  null,
                  g.alignTo
                );
                a();
      ...
      y.prototype.updateEvents = function (g) {
        var h = this.chart;
        m(g.enableDoubleClickZoom, g.enabled) || g.enableDoubleClickZoomTo
          ? (this.unbindDblClick =
              this.unbindDblClick ||
              L(h.container, "dblclick", function (g) {
                h.pointer.onContainerDblClick(g);
              }))
          : this.unbindDblClick &&
            (this.unbindDblClick = this.unbindDblClick());
        m(g.enableMouseWheelZoom, g.enabled)
          ? (this.unbindMouseWheel =
              this.unbindMouseWheel ||
              L(
                h.container,
                "undefined" === typeof F.onmousewheel
                  ? "DOMMouseScroll"
                  : "mousewheel",
                function (g) {
      ...
      G(n.prototype, {
        ...
        mapZoom: function (g, h, n, r, q) {
          ...
          k = this.fitToBox(
            {
              x: k - c * (r ? (r - u.pos) / u.len : 0.5),
              y: f - e * (q ? (q - p.pos) / p.len : 0.5),
              width: c,
              height: e,
            },
            {
          ...
          c =
            k.x <= u.dataMin &&
            k.width >= u.dataMax - u.dataMin &&
            k.y <= p.dataMin &&
            k.height >= p.dataMax - p.dataMin;
          r && u.mapAxis && (u.mapAxis.fixTo = [r - u.pos, h]);
          q && p.mapAxis && (p.mapAxis.fixTo = [q - p.pos, n]);
          "undefined" === typeof g || c
            ? (u.setExtremes(void 0, void 0, !1),
              p.setExtremes(void 0, void 0, !1))
            : (u.setExtremes(k.x, k.x + k.width, !1),
              p.setExtremes(k.y, k.y + k.height, !1));
          this.redraw();
        },
      });
  ...
  O(
    q,
    "Maps/MapPointer.js",
    [q["Core/Pointer.js"], q["Core/Utilities.js"]],
    function (n, h) {
      var q = h.extend,
        z = h.pick;
      h = h.wrap;
      q(n.prototype, {
        onContainerDblClick: function (h) {
          var n = this.chart;
          h = this.normalize(h);
          n.options.mapNavigation.enableDoubleClickZoomTo
            ? n.pointer.inClass(h.target, "highcharts-tracker") &&
              n.hoverPoint &&
              n.hoverPoint.zoomTo()
            : n.isInsidePlot(h.chartX - n.plotLeft, h.chartY - n.plotTop) &&
              n.mapZoom(
                0.5,
                n.xAxis[0].toValue(h.chartX),
                n.yAxis[0].toValue(h.chartY),
                h.chartX,
                h.chartY
              );
        },
        onContainerMouseWheel: function (h) {
          ...
          n.isInsidePlot(h.chartX - n.plotLeft, h.chartY - n.plotTop) &&
            n.mapZoom(
              Math.pow(n.options.mapNavigation.mouseWheelSensitivity, q),
              n.xAxis[0].toValue(h.chartX),
              n.yAxis[0].toValue(h.chartY),
              h.chartX,
              h.chartY
  ...
  O(
    ...
    function (n, h, q, z, y) {
      ...
      y = h.Renderer;
      var m = h.VMLRenderer;
      L(q.lang, { zoomIn: "Zoom in", zoomOut: "Zoom out" });
      q.mapNavigation = {
        buttonOptions: {
          alignTo: "plotBox",
          align: "left",
      ...
      y === m &&
        ["topbutton", "bottombutton"].forEach(function (g) {
      ...
      n.seriesType(
        ...
        p(h.colorMapSeriesMixin, {
          ...
          getBox: function (b) {
            ...
            (b || []).forEach(function (b) {
              if (b.path) {
                "string" === typeof b.path
                  ? (b.path = g(b.path))
                  : "M" === b.path[0] &&
                    (b.path = M.prototype.pathToSegments(b.path));
                var d = b.path || [],
                  p = -a,
                  m = a,
                  r = -a,
                ...
                b._foundBox ||
                  ...
                  (b._midX =
                    m + (p - m) * c(b.middleX, u && u["hc-middle-x"], 0.5)),
                  (b._midY =
                    q + (r - q) * c(b.middleY, u && u["hc-middle-y"], 0.5)),
                  (b._maxX = p),
                  (b._minX = m),
                  (b._maxY = r),
                  (b._minY = q),
                  (b.labelrank = c(b.labelrank, (p - m) * (r - q))),
                  (b._foundBox = !0));
            ...
            n &&
              ((this.minY = Math.min(k, c(this.minY, a))),
              (this.maxY = Math.max(h, c(this.maxY, -a))),
              (this.minX = Math.min(f, c(this.minX, a))),
              (this.maxX = Math.max(e, c(this.maxX, -a))),
              p &&
              ...
              b.forEach(function (a, c) {
                ...
                if (A(a)) b[c] = { value: a };
                  ...
                  !g.keys &&
                    ...
                    "string" === typeof a[0] &&
                    ((b[c]["hc-key"] = a[0]), ++d);
                  for (var e = 0; e < x.length; ++e, ++d)
                    x[e] &&
                      "undefined" !== typeof a[d] &&
                      (0 < x[e].indexOf(".")
                        ? F.prototype.setNestedProperty(b[c], a[d], x[e])
                        : (b[c][x[e]] = a[d]));
                }
                r && "_i" === r[0] && (b[c]._i = c);
              });
            this.getBox(b);
            (this.chart.mapTransforms = t =
              (h && h.mapTransforms) || (n && n["hc-transform"]) || t) &&
              k(t, function (a) {
                a.rotation &&
            ...
            if (n) {
              ...
              if (g.allAreas) {
                ...
                w =
                  ...
                  "|";
                n.forEach(function (a) {
                  (r[0] && -1 !== w.indexOf("|" + a[r[0]] + "|")) ||
                    (b.push(p(a, { value: null })), (e = !1));
                });
              } else this.getBox(w);
            }
            f.prototype.setData.call(this, b, a, c, e);
          },
          drawGraph: r,
          drawDataLabels: r,
          ...
          translate: function () {
            ...
            b.data.forEach(function (f) {
              A(f._midX) &&
                A(f._midY) &&
                ((f.plotX = a.toPixels(f._midX, !0)),
                (f.plotY = c.toPixels(f._midY, !0)));
              e &&
                ((f.shapeType = "path"),
                (f.shapeArgs = { d: b.translatePath(f.path) }));
            });
            H(b, "afterTranslate");
          },
          pointAttribs: function (e, a) {
            a = e.series.chart.styledMode
              ? this.colorAttribs(e)
              : b.column.prototype.pointAttribs.call(this, e, a);
            a["stroke-width"] = c(
              e.options[
          ...
          drawPoints: function () {
            var e = this,
              ...
              p = this.baseTrans;
            e.transformGroup ||
              ((e.transformGroup = k.g().attr({ scaleX: 1, scaleY: 1 }).add(g)),
              (e.transformGroup.survive = !0));
            if (e.doFullTranslate())
              h.hasRendered &&
                !h.styledMode &&
                ...
                (e.group = e.transformGroup),
                b.column.prototype.drawPoints.apply(e),
                (e.group = g),
                e.points.forEach(function (a) {
                  if (a.graphic) {
                    var b = "";
                    ...
                    h.styledMode &&
                      a.graphic.css(
                        e.pointAttribs(a, (a.selected && "select") || void 0)
                      );
                  }
                }),
                (this.baseTrans = {
                  ...
                  originY:
                    f.min -
                    f.minPixelPadding / f.transA +
                    (f.reversed ? 0 : f.len / f.transA),
                  transAX: a.transA,
                  transAY: f.transA,
                }),
              ...
              0.99 < m &&
                ...
                0.99 < n &&
                1.01 > n &&
                ((n = m = 1), (r = Math.round(r)), (q = Math.round(q)));
              ...
              if (h.renderer.globalAnimation) {
                ...
                d.attr({ translateX: r, translateY: q, scaleX: m, scaleY: n });
            }
            h.styledMode ||
              g.element.setAttribute(
                ...
                c(
                  e.options[
                    (e.pointAttrToOptions &&
                      e.pointAttrToOptions["stroke-width"]) ||
                      "borderWidth"
                  ],
                  1
                ) / (m || 1)
          ...
          render: function () {
            ...
            b.chart.renderer.isVML && 3e3 < b.data.length
              ? setTimeout(function () {
                  a.call(b);
                })
              : a.call(b);
          ...
          animate: function (b) {
            ...
            this.chart.renderer.isSVG &&
              ...
              b
                ...
                : c.animate(
                    { translateX: g, translateY: h, scaleX: 1, scaleY: 1 },
                    a
                  ));
          },
          animateDrilldown: function (b) {
            ...
            b ||
              ((b = Math.min(e.width / a.width, e.height / a.height)),
              (c.shapeArgs = {
                scaleX: b,
                scaleY: b,
                translateX: e.x,
          ...
          animateDrillupTo: function (c) {
            b.column.prototype.animateDrillupTo.call(this, c);
          },
        }),
        D(
          {
            applyOptions: function (b, a) {
              ...
              c.mapData &&
                c.mapMap &&
                ((a = F.prototype.getNestedProperty.call(b, a[1])),
                (a = "undefined" !== typeof a && c.mapMap[a])
                  ? (c.xyFromShape && ((b.x = a._midX), (b.y = a._midY)),
                    D(b, a))
            ...
            onMouseOver: function (b) {
              ...
              if (null !== this.value || this.series.options.nullInteraction)
                F.prototype.onMouseOver.call(this, b);
  ...
  O(
    ...
    function (n, h, q, z) {
      ...
      n.seriesType(
        ...
        {
          applyOptions: function (h, n) {
            h =
              "undefined" !== typeof h.lat && "undefined" !== typeof h.lon
                ? y(h, this.series.chart.fromLatLonToPoint(h))
                : h;
    ...
    function (n, h, q, z, y) {
      ...
      D = (function () {
        ...
        h.prototype.drawLegendSymbol = function (h) {
          ...
          this.fontMetrics = c.renderer.fontMetrics(
            e.labels.style.fontSize.toString() + "px"
          );
          b && b.length && B(b[0].value)
            ? (H(b, function (a, b) {
              ...
              (k = 0 < k ? k : 0),
              (this.maxLabel = c),
              (this.movementX = "left" === e.labels.align ? k : 0),
              (this.legendItemWidth = h + k + f),
              (this.legendItemHeight = h + this.fontMetrics.h / 2))
            : (h.options.bubbleLegend.autoRanges = !0);
        };
        h.prototype.setOptions = function () {
          ...
          h.forEach(function (k, n) {
            m ||
              ((b.stroke = g(k.borderColor, c.borderColor, e.color)),
              (b.fill = g(
                k.color,
                c.color,
                1 !== p ? F(e.color).setOpacity(p).get("rgba") : e.color
              )),
              (l.stroke = g(k.connectorColor, c.connectorColor, e.color)));
            h[n].radius = this.getRangeRadius(k.value);
            h[n] = r(h[n], { center: h[0].radius - h[n].radius + f });
            m ||
              r(!0, h[n], {
                bubbleStyle: r(!1, b),
        ...
        h.prototype.renderRange = function (g) {
          ...
          "center" === m &&
            ...
            (g.labelStyle.align = "center"));
          m = q + c.labels.y;
          var v = r + p + c.labels.x;
          b.bubbleItems.push(
            f
              .circle(r, a + ((q % 1 ? 1 : 0.5) - (e % 2 ? 0 : 0.5)), k)
              .attr(u ? {} : g.bubbleStyle)
              .addClass(
                (u
        ...
        h.prototype.formatLabel = function (g) {
          var c = this.options,
        ...
        h.prototype.hideOverlappingLabels = function () {
          ...
          !this.options.labels.allowOverlap &&
            c &&
            (g.hideOverlappingLabels(c.labels),
            c.labels.forEach(function (e, f) {
              e.newOpacity
                ? e.newOpacity !== e.oldOpacity && c.connectors[f].show()
                : c.connectors[f].hide();
            }));
        };
          ...
          h.chart.series.forEach(function (a) {
            a.isBubble &&
              ...
              e.length &&
                ...
                (b = g(a.options.zMax, Math.max(b, L(e))))));
          });
          var l =
            f === b
              ? [{ value: b }]
        ...
        h.prototype.predictBubbleSizes = function () {
          var g = this.chart,
            c = this.fontMetrics,
            e = g.legend.options,
      ...
      h(z, "afterGetAllItems", function (g) {
        ...
        0 <= f &&
          ...
          e.enabled &&
          ((e.seriesIndex = f),
          (this.bubbleLegend = new q.BubbleLegend(e, this)),
      ...
      n.prototype.getVisibleBubbleSeriesIndex = function () {
        for (var g = this.series, h = 0; h < g.length; ) {
          if (g[h] && g[h].isBubble && g[h].visible && g[h].zData.length)
            return h;
          h++;
        }
        return -1;
      ...
      z.prototype.getLinesHeights = function () {
        ...
        for (e = 0; e < c; e++)
          if (
            (g[e].legendItemHeight && (g[e].itemHeight = g[e].legendItemHeight),
            g[e] === g[c - 1] ||
              (g[e + 1] &&
                g[e]._legendItemPos[1] !== g[e + 1]._legendItemPos[1]))
          ) {
            h.push({ height: 0 });
            var b = h[h.length - 1];
            for (f; f <= e; f++)
              g[f].itemHeight > b.height && (b.height = g[f].itemHeight);
            b.step = e;
          }
        return h;
      };
      z.prototype.retranslateItems = function (g) {
        ...
        this.allItems.forEach(function (k, a) {
          ...
          if ((e = k.movementX) || (f && k.ranges))
            (e = f ? h - k.options.maxSize / 2 : h + e),
              k.legendGroup.attr({ translateX: e });
          a > g[b].step && b++;
          k.legendGroup.attr({ translateY: Math.round(c + g[b].height / 2) });
          k._legendItemPos[1] = c + g[b].height / 2;
        });
      };
      h(u, "legendItemClick", function () {
        ...
        c &&
          ...
          ((this.visible = !h),
          (this.ignoreSeries = h),
          (g = 0 <= g.getVisibleBubbleSeriesIndex()),
          c.bubbleLegend.visible !== g &&
            (c.update({ bubbleLegend: { enabled: g } }),
            (c.bubbleLegend.visible = g)),
          (this.visible = h));
      });
      v(n.prototype, "drawChartBox", function (g, h, c) {
        ...
        } else g.call(this, h, c), e && e.options.enabled && e.bubbleLegend && (e.render(), e.retranslateItems(e.getLinesHeights()));
      });
      q.BubbleLegend = D;
  ...
  O(
    ...
    function (n, h, q, z, y, F) {
      ...
      h.seriesType(
            ...
            !g &&
              ...
              this.points.forEach(function (g) {
                ...
                h &&
                  h.width &&
                  (this.hasRendered ||
                    h.attr({ x: g.plotX, y: g.plotY, width: 1, height: 1 }),
        ...
        {
          haloPath: function (g) {
            return y.prototype.haloPath.call(
              this,
              0 === g ? 0 : (this.marker ? this.marker.radius || 0 : 0) + g
            );
          },
          ttBelow: !1,
        }
      ...
      n.prototype.beforePadding = function () {
        ...
        this.series.forEach(function (b) {
          var c = b.options;
          !b.bubblePadding ||
            (!b.visible && k.options.chart.ignoreHiddenSeries) ||
            ((h.allowZoomOutside = !0),
            z.push(b),
            f &&
              ...
              (b.minPxSize = a.minSize),
              (b.maxPxSize = Math.max(a.maxSize, a.minSize)),
              (b = b.zData.filter(g)),
              b.length &&
                ((q = D(
                  c.zMin,
                  r(
                    B(b),
                    !1 === c.displayNegative ? c.zThreshold : -Number.MAX_VALUE,
                    q
                  )
                )),
                (u = D(c.zMax, Math.max(u, G(b)))))));
        });
        ...
        z.length &&
          ...
          !this.logarithmic &&
          ((e -= m),
          (y *= (m + Math.max(0, c) - Math.min(e, m)) / m),
          [
            ["min", "userMin", c],
            ["max", "userMax", e],
          ].forEach(function (a) {
            "undefined" === typeof D(h.options[a[0]], h[a[1]]) &&
              (h[a[0]] += a[2] / y);
          }));
      };
      ("");
    ...
    function (n, h, q) {
      ...
      y.bubble &&
        n.seriesType(
          ...
          {
            applyOptions: function (n, q) {
              return n &&
                "undefined" !== typeof n.lat &&
                "undefined" !== typeof n.lon
                ? h.prototype.applyOptions.call(
                    this,
                    z(n, this.series.chart.fromLatLonToPoint(n)),
                    q
                  )
      ...
      n.seriesType(
        ...
        D(h, {
          ...
          init: function () {
            ...
            r(u, { ellipse: u.circle, rect: u.square });
          },
          getSymbol: v.prototype.getSymbol,
          setClip: function (g) {
            var h = this.chart;
            v.prototype.setClip.apply(this, arguments);
            (!1 !== this.options.clip || g) &&
              this.markerGroup.clip(
                (g || this.clipBox) && this.sharedClipKey
          ...
          translate: function () {
            ...
            this.points.forEach(function (e) {
              ...
              var g = (e.hasImage =
                0 ===
                ((e.marker && e.marker.symbol) || h || "").indexOf("url"));
              if (c) {
              ...
              a = {
                ...
                clientX: (f.x1 + f.x2) / 2,
                shapeType: "path",
                shapeArgs: D(!0, b, { d: u[k](b.x, b.y, b.width, b.height) }),
              };
              g && (e.marker = { width: b.width, height: b.height });
              r(e, a);
            });
            m(this, "afterTranslate");
          },
          pointAttribs: function (g, h) {
            var k = v.prototype.pointAttribs.call(this, g, h),
              c = this.options || {},
            ...
            h &&
              ((g = D(
                c.states[h],
                c.marker && c.marker.states[h],
                (g.options.states && g.options.states[h]) || {}
              )),
              (h = g.brightness),
              (k.fill =
                g.color ||
          ...
          markerAttribs: function (g, h) {
            var k = g.marker || {},
              ...
              e = g.shapeArgs || {},
              f = {};
            if (g.hasImage) return { x: g.plotX, y: g.plotY };
            if (h) {
              var b = c.states[h] || {};
          ...
          drawPoints: function () {
            ...
            if ((this.options.marker || {}).enabled || this._hasPointMarkers)
              v.prototype.drawPoints.call(this),
                this.points.forEach(function (h) {
                  h.graphic &&
                    h.graphic[g.chart.styledMode ? "css" : "animate"](
                      g.colorAttribs(h)
                    );
                });
          },
          ...
          getCellAttributes: function () {
            ...
            var l = H(this.pointPadding, h.pointPadding, 0),
              a = {
                x1: B(
                  Math.round(
                    e.len - (e.translate(this.x - k, !1, !0, !1, !0, -g) || 0)
                  ),
                  -e.len,
                  2 * e.len
                ),
                ...
                y1: B(
                  Math.round(f.translate(this.y - c, !1, !0, !1, !0) || 0),
                  -f.len,
                  2 * f.len
                ),
                y2: B(
            ...
            [
              ...
              b[e] &&
                b[e] < h &&
                ((a[f] = m - b[e] / 2 - k / 2), (a[g] = m + b[e] / 2 + k / 2));
              l &&
                ("y" === c && ((f = g), (g = c + "1")),
                (a[f] += l),
                (a[g] -= l));
    ...
    function (n, h, q) {
      function z(h, m) {
        ...
        for (g = m.length - 1; h < m.length; g = h++) {
          ...
          u !== y &&
            r <
              ((m[g][0] - m[h][0]) * (q - m[h][1])) / (m[g][1] - m[h][1]) +
                m[h][0] &&
            (n = !n);
        }
        return n;
      ...
      n.prototype.transformFromLatLon = function (h, m) {
        var g,
          n =
            (null === (g = this.userOptions.chart) || void 0 === g
              ? void 0
              : g.proj4) || y.proj4;
        if (!n) return F(21, !1, this), { x: 0, y: null };
        ...
        return {
          x:
            ((h[0] - (m.xoffset || 0)) * (m.scale || 1) + (m.xpan || 0)) *
              (m.jsonres || 1) +
            (m.jsonmarginX || 0),
          y:
            (((m.yoffset || 0) - h[1]) * (m.scale || 1) + (m.ypan || 0)) *
              (m.jsonres || 1) -
            (m.jsonmarginY || 0),
        };
      };
      n.prototype.transformToLatLon = function (h, m) {
        if ("undefined" === typeof y.proj4) F(21, !1, this);
          ...
          h = {
            x:
              ((h.x - (m.jsonmarginX || 0)) / (m.jsonres || 1) -
                (m.xpan || 0)) /
                (m.scale || 1) +
              (m.xoffset || 0),
            y:
              ((-h.y - (m.jsonmarginY || 0)) / (m.jsonres || 1) +
                (m.ypan || 0)) /
                (m.scale || 1) +
              (m.yoffset || 0),
          };
          ...
          m = y.proj4(
            m.crs,
            "WGS84",
            m.rotation ? { x: h.x * g + h.y * -n, y: h.x * n + h.y * g } : h
          );
          return { lat: m.y, lon: m.x };
        }
      };
      n.prototype.fromPointToLatLon = function (h) {
        ...
        if (m) {
          for (g in m)
            if (
              ...
              m[g].hitZone &&
              z({ x: h.x, y: -h.y }, m[g].hitZone.coordinates[0])
            )
              return this.transformToLatLon(h, m[g]);
      ...
      n.prototype.fromLatLonToPoint = function (h) {
        var m = this.mapTransforms,
          g;
        if (!m) return F(22, !1, this), { x: 0, y: null };
        for (g in m)
          if (Object.hasOwnProperty.call(m, g) && m[g].hitZone) {
            var n = this.transformFromLatLon(h, m[g]);
            if (z({ x: n.x, y: -n.y }, m[g].hitZone.coordinates[0])) return n;
          }
        return this.transformFromLatLon(h, m["default"]);
      };
      h.geojson = function (h, m, g) {
        ...
        h.features.forEach(function (g) {
          ...
          "map" === m || "mapbubble" === m
            ...
            ? ("LineString" === p
                ? r(h)
                : "MultiLineString" === p && h.forEach(r),
              q.length && (k = { path: q }))
            : "mappoint" === m && "Point" === p && (k = { x: h[0], y: -h[1] });
          k && n.push(L(k, { name: g.name || g.NAME, properties: g }));
        });
        g &&
          h.copyrightShort &&
          ((g.chart.mapCredits = G(g.chart.options.credits.mapText, {
            geojson: h,
          })),
