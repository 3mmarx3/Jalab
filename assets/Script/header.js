          ...
          <div class="header-body px-3 px-xxl-5 py-3 py-lg-4">
            <div class="row align-items-center">
              <a
                ...
                class="muze-hamburger d-block d-lg-none col-auto"
              >
                <img src="../assets/svg/icons/hamburger1.svg" alt="img" />
                <img
                  src="../assets/svg/icons/close1.svg"
                  style="width: 20px"
                  class="menu-close"
                  alt="img"
                />
                      ...
                      <li class="nav-item">
                        ...
                        >
                          <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                              <a href="project-management.html" class="nav-link"
                      ...
                      <li class="nav-item">
                        ...
                        >
                          <ul class="nav nav-sm flex-column" id="submenu4">
                            ...
                            <li class="nav-item">
                              ...
                              >
                                <ul class="nav nav-sm flex-column">
                                  ...
                                  <li class="nav-item">
                                    <a href="new-project.html" class="nav-link"
                                      >New project</a
                                    >
                                  </li>
                                  <li class="nav-item">
                            ...
                            <li class="nav-item">
                              <a href="empty-state.html" class="nav-link"
                                >Empty State</a
                              >
                            </li>
                          </ul>
                      ...
                      <li class="nav-item">
                        ...
                        >
                          <ul class="nav nav-sm flex-column" id="submenu5">
                            <li class="nav-item">
                              ...
                              >
                                <ul class="nav nav-sm flex-column">
                                  ...
                                  <li class="nav-item">
                                    <a href="signin-cover.html" class="nav-link"
                                      >Cover</a
                                    >
                                  </li>
                                </ul>
                            ...
                            <li class="nav-item">
                              ...
                              >
                                <ul class="nav nav-sm flex-column">
                                  ...
                                  <li class="nav-item">
                                    <a href="signup-cover.html" class="nav-link"
                                      >Cover</a
                                    >
                                  </li>
                                </ul>
                            ...
                            <li class="nav-item">
                              <a href="404-error.html" class="nav-link"
                                >Error 404</a
                              >
                            </li>
                            <li class="nav-item">
                              <a href="500-error.html" class="nav-link"
                                >Error 500</a
                              >
                            </li>
                          </ul>
                      ...
                      <li class="nav-item">
                        ...
                        >
                          ...
                          &nbsp;<span class="ms-2 position-relative"
                            >Apps
                            <sup class="status bg-warning position-absolute"
                              >&nbsp;</sup
                            ></span
                          >
                        </a>
                        ...
                        >
                          <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                              <a href="file-manager.html" class="nav-link"
                                >File manager</a
                              >
                            </li>
                            <li class="nav-item">
              ...
              >
                ...
                <div class="dropdown grid-option">
                  <a
                    href="#"
                    class="text-dark ms-4 ms-xxl-5 mb-0 notification"
                  ...
                  >
                    ...
                    >
                      <span
                        class="fs-16 Montserrat-font font-weight-semibold text-black-600"
                        >Messages</span
                      >
                      <div class="dropdown ms-auto">
                        <a
                          ...
                          aria-expanded="false"
                          id="morebtn2"
                          class="btn btn-dark-100 btn-icon btn-sm rounded-circle my-1"
                        >
                          <svg
                            data-name="Icons/Tabler/Notification"
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <ul
                      class="nav nav-tabs nav-tabs-sm nav-tabs-line"
                      id="myTab"
                      role="tablist"
                    >
                        ...
                        <div class="dropdown-body" data-simplebar>
                          <a href="#" class="dropdown-item text-wrap">
                            <div class="media">
                              <span class="d-flex align-items-center">
                                <span
                                  class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0"
                                  >&nbsp;</span
                                >
                                <span
                                  class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"
                                  ><img
                                    src="../assets/img/avatar-sm3.png"
                                    alt="Facebook"
                                  /><span
                                    class="avatar-status avatar-sm-status avatar-success"
                                    >&nbsp;</span
                                  ></span
                                >
                              </span>
                              <div class="media-body ps-1">
                                <div class="d-flex align-items-center">
                                  <span
                                    class="fs-16 font-weight-semibold dropdown-title"
                                    >John Wick</span
                                  >
                                  <span
                                    class="font-weight-semibold tiny text-gray-600 ms-auto"
                                    >Just now</span
                                  >
                                </div>
                                <span
                                  class="d-block small text-gray-600 mt-1 dropdown-content"
                                  >Hey, I just found out what’s causing the
                                  server to crash!</span
                                >
                              </div>
                            </div>
                          </a>
                          <a href="#" class="dropdown-item text-wrap unread">
                            <div class="media">
                              <span class="d-flex align-items-center">
                                <span
                                  class="avatar-status avatar-sm-status avatar-primary position-relative me-2 end-0 bottom-0"
                                  >&nbsp;</span
                                >
                                <span
                                  class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"
                                  ><img
                                    src="../assets/img/avatar-sm4.png"
                                    alt="Facebook"
                                  /><span
                                    class="avatar-status avatar-sm-status avatar-success"
                                    >&nbsp;</span
                              ...
                              <div class="media-body ps-1">
                                ...
                                <span
                                  class="d-block small text-gray-600 mt-1 dropdown-content"
                                  >What about some coffee this afternoon to
                                  discuss?</span
                                >
                              </div>
                            </div>
                    ...
                    <div
                      class="dropdown-footer text-center py-2 border-top border-gray-50"
                    >
                ...
                <div class="dropdown grid-option">
                  <a
                    href="#"
                    class="text-dark ms-4 ms-xxl-5 h5 mb-0"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                    id="chat"
                  >
                    ...
                    >
                      <g
                        id="Icons_Tabler_Settings"
                        data-name="Icons/Tabler/Settings"
                        transform="translate(0 0)"
                      >
                        <rect
                          id="Icons_Tabler_Message_background"
                          data-name="Icons/Tabler/Message background"
                          width="24"
                          height="24"
                          fill="none"
                        />
                        <path
                          d="M1.029,24H.976l-.046,0-.1-.014L.74,23.958l-.089-.03-.082-.038-.095-.053-.089-.065-.05-.043-.066-.065-.042-.05-.065-.089a.943.943,0,0,1-.054-.095L.072,23.35l-.016-.045-.022-.073-.015-.065-.007-.039L0,23.07l0-.1V5.144A5.122,5.122,0,0,1,4.967,0l.177,0H18.857A5.122,5.122,0,0,1,24,4.967l0,.177v8.228a5.121,5.121,0,0,1-4.967,5.139l-.177,0H6.939L1.723,23.73l-.072.061-.076.051-.04.024-.046.024-.1.043-.073.024-.093.023-.1.014-.046,0ZM5.144,2.057A3.081,3.081,0,0,0,2.061,4.988l0,.155V20.488l3.73-3.729a1.032,1.032,0,0,1,.61-.3l.116-.007H18.857a3.081,3.081,0,0,0,3.082-2.931l0-.154V5.144a3.081,3.081,0,0,0-2.932-3.082l-.154,0Z"
                          transform="translate(0 0)"
                          fill="#1e1e1e"
                        />
                      </g>
                  ...
                  >
                    <div
                      class="dropdown-header d-flex align-items-center px-4 py-2"
                    >
                      <span
                        class="fs-16 Montserrat-font font-weight-semibold text-black-600"
                        >Notification</span
                        ...
                        <div class="media">
                          <span class="d-flex align-items-center">
                            ...
                            <span
                              class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"
                              ><img
                                src="../assets/svg/icons/google-icon.svg"
                                alt="Facebook"
                            /></span>
                          </span>
                          <div class="media-body ps-1">
                            ...
                            <span
                              class="d-block small text-gray-600 mt-1 dropdown-content"
                              >Hey, I just found out what’s causing the server
                              to crash!</span
                            >
                          </div>
                        </div>
                        ...
                        <div class="media">
                          <span class="d-flex align-items-center">
                            ...
                            <span
                              class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"
                              ><img
                                src="../assets/svg/icons/facebook3.svg"
                                alt="Facebook"
                            /></span>
                          </span>
                          <div class="media-body ps-1">
                            ...
                            <span
                              class="d-block small text-gray-600 mt-1 dropdown-content"
                              >I finally got the present I mentioned to Steven,
                              you’ll love it</span
                            >
                          </div>
                        </div>
                        ...
                        <div class="media align-items-center">
                          <span class="me-3">
                            <img
                              ...
                              src="../assets/svg/icons/google-analytics-3.svg"
                              alt="Icon"
                            />
                          </span>
                          <div class="media-body">
                            ...
                            <span
                              class="d-block small text-gray-600 mt-1 dropdown-content"
                              >Instant stats for your apps and websites</span
                            >
                          </div>
                        </div>
                      </a>
                      <a href="#" class="dropdown-item text-wrap">
                        <div class="media align-items-center">
                          <span class="me-3">
                            <img
                              class="avatar avatar-xs rounded-0"
                              src="../assets/svg/icons/dribbble-icon-1.svg"
                              alt="Icon"
                            />
                          </span>
                          <div class="media-body">
                            <span
                              class="fs-16 font-weight-semibold dropdown-title me-2"
                              >Dribbble</span
                            ><span
                              class="badge badge-primary py-1 px-2 text-uppercase"
                              >New</span
                            >
                            <span
                              class="d-block small text-gray-600 mt-1 dropdown-content"
                      ...
                      <a href="#" class="dropdown-item text-wrap">
                        <div class="media align-items-center">
                          <span class="me-3">
                            <img
                              class="avatar avatar-xs rounded-0"
                              src="../assets/svg/icons/evernote-icon.svg"
                              alt="Icon"
                            />
                          </span>
                          <div class="media-body">
                      ...
                      <a href="#" class="dropdown-item text-wrap">
                        <div class="media align-items-center">
                          <span class="me-3">
                            <img
                              class="avatar avatar-xs rounded-0"
                              src="../assets/svg/icons/dropbox.svg"
                              alt="Icon"
                            />
                          </span>
                          <div class="media-body">
                ...
                <div class="dropdown profile-dropdown">
                  <a
                    href="#"
                    class="avatar avatar-sm avatar-circle ms-4 ms-xxl-5"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  ...
                  >
                    <img
                      ...
                      alt="Avatar"
                    />
                    <span class="avatar-status avatar-sm-status avatar-success"
                      >&nbsp;</span
                    >
                  </a>
                  <ul
                  ...
                  >
                    <li class="pt-2 px-4">
                      <span
                        class="fs-16 font-weight-bold text-black-600 Montserrat-font me-2"
                        >Bruce Lee</span
                      ><img
                        src="../assets/svg/icons/fill-check.svg"
                        alt="icon"
                      />
                      <small class="text-gray-600 pb-3 d-block"
                        >lee@bruce.com</small
                      >
                    </li>
                    <li class="dropdown">
                      <a
                        ...
                        ><img
                          src="../assets/svg/icons/right-arrow@10.svg"
                          alt="Right Arrow"
                          class="ms-auto"
                      /></a>
                      <ul
                      ...
                      >
                        <li>
                          <a class="dropdown-item" href="#"
                            ...
                            ><span class="ms-2">Available</span></a
                          >
                        </li>
                        <li>
                          <a class="dropdown-item" href="#"
                            ><span class="status dnd"></span
                            ><span class="ms-2">Busy</span></a
                          >
                        </li>
                        <li>
                          <a class="dropdown-item" href="#"
                            ><span class="status away"></span
                            ><span class="ms-2">Away</span></a
                          >
                        </li>
                        <li>
                          <a class="dropdown-item" href="#"
                            ><span class="status offline"></span
                            ><span class="ms-2">Offline</span></a
                          >
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="#"
                        ...
                        >
                          <rect
                            data-name="Icons/Tabler/Bookmark background"
                            width="16"
                            height="16"
                            fill="none"
                          />
                ...
                <a
                  href="javascript:void(0);"
                  class="btn btn-dark btn-lg customize-btn ms-4 ms-xxl-5"
                  ><svg
                    data-name="Icons/Tabler/Notification"
                    xmlns="http://www.w3.org/2000/svg"
                    width="14"
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="#fff"
                    /></svg
                  ><span class="ps-2">Customize</span></a
                >
              </div>
            </div>
          </div>
                      ...
                      <ul class="nav nav-sm flex-column" id="submenu7">
                        <li class="nav-item">
                          ...
                          >
                            <ul class="nav nav-sm flex-column">
                              <li class="nav-item">
                                <a href="signin-simple.html" class="nav-link"
                                  >Simple</a
                                >
                              </li>
                              <li class="nav-item">
                        ...
                        <li class="nav-item">
                          ...
                          >
                            <ul class="nav nav-sm flex-column">
                              <li class="nav-item">
                                <a href="signup-simple.html" class="nav-link"
                                  >Simple</a
                                >
                              </li>
                              <li class="nav-item">
